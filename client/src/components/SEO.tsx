...
const staticPageSEO: Record<string, SEOProps> = {
    ...
    '/access': {
        ...
        description: 'Enter your access code to unlock and download encrypted files. Zero-knowledge decryption happens entirely in your browser. No data is ever exposed to the server.',
