import { c as Se, r as o, j as e, ao as Ce, a8 as Ie, f as ge, m as Z, o as Ee, ap as Ae, B as F, l as Y, ad as ce, e as se, A as Pe, aq as me, ar as Le, ai as Fe, ak as $e, L as ue, k as Me, Z as Re, as as Ue, am as Te } from "./index-B1Hr3-ke.js";
import { I as Ve } from "./input-Dekh5BdI.js";
import { H as _e } from "./hard-drive-Ce-h8jiN.js";
import { T as X } from "./triangle-alert-koWQTrZu.js";
import { S as re } from "./shield-check-C5nQRT_u.js";
import { D as ae } from "./download-D5uJHc2F.js";
import { E as Be } from "./external-link-BfZeCDC4.js";
import { M as Oe } from "./mail-CSxlCv48.js";
import { s as ee, i as xe } from "./downloadStream-BNghRPeb.js";
import { F as Ge } from "./file-BypphTUm.js";
/**
  ...
  o.useEffect(() => (L.current = new Worker(new URL("/assets/encryption.worker-UhEl2skF.js", import.meta.url), { type: "module" }), () => L.current?.terminate()), []), o.useEffect(() => {
    ...
    y && (async () => {
      if (y) try {
        const n = await Ue(m);
        p(n);
        const l = (await Te(y.encryptedMetadata, n)).map((w) => {
