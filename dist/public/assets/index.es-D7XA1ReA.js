import { aM as Qe, aN as Io } from "./index-ByPnYQL4.js";
import { _ as za } from "./access-Bw62xch3.js";
import "./input-DolBa97i.js";
import "./chevron-right-BLrWMnSe.js";
import "./triangle-alert-DeVGu1DU.js";
import "./circle-LBgXq6Zc.js";
import "./browser-CYtTV5sA.js";
import "./use-mobile-u7sZ9hL4.js";
import "./timer-IdBnPe7t.js";
import "./file-text-S9aBAa-T.js";
import "./downloadStream-BApq0bc3.js";
import "./activity-WYtS4SgG.js";
import "./chevron-up-C0ZX9uWa.js";
import "./hard-drive-H81IJ4GU.js";
import "./zap-DvzBzPZR.js";
import "./upload-DThiedef.js";
import "./external-link-CWoGuLAF.js";
import "./mail-DFiQb-eb.js";
import "./sparkles-DhwimIJN.js";
import "./key-round-mNX63hXT.js";
import "./shield-check-BSGM-k8u.js";
var ht = function(a3) {
  ...
  return this;
}() || Function("return this")(), Et = {}, D = function(a3) {
  try {
    return !!a3();
  } catch {
    return true;
...
var xi = function(a3, e) {
  return { enumerable: !(a3 & 1), configurable: !(a3 & 2), writable: !(a3 & 4), value: e };
}, Do = br, Lo = Function.prototype, Ha = Lo.call, Pl = Do && Lo.bind.bind(Ha, Ha), L = Do ? Pl : function(a3) {
  return function() {
    return Ha.apply(a3, arguments);
  };
}, ko = L, Rl = ko({}.toString), Nl = ko("".slice), je = function(a3) {
  return Nl(Rl(a3), 8, -1);
  ...
  return a3 == null;
}, Dl = xr, Ll = TypeError, ve = function(a3) {
  if (Dl(a3)) throw new Ll("Can't call method on " + a3);
  return a3;
}, kl = Bo, Bl = ve, $t = function(a3) {
  return kl(Bl(a3));
}, Jr = typeof document == "object" && document.all, B = typeof Jr > "u" && Jr !== void 0 ? function(a3) {
  return typeof a3 == "function" || a3 === Jr;
} : function(a3) {
  return typeof a3 == "function";
}, jl = B, ae = function(a3) {
  return typeof a3 == "object" ? a3 !== null : jl(a3);
}, ea = _, Fl = B, Ul = function(a3) {
...
var Ti = cr, xn = Ti, Hl = D, Yl = _, Xl = Yl.String, Fo = !!Object.getOwnPropertySymbols && !Hl(function() {
  ...
  return !Xl(a3) || !(Object(a3) instanceof Symbol) || !Symbol.sham && xn && xn < 41;
}), Wl = Fo, Uo = Wl && !Symbol.sham && typeof Symbol.iterator == "symbol", ql = Fe, Ql = B, Kl = Tr, Zl = Uo, Jl = Object, Go = Zl ? function(a3) {
  return typeof a3 == "symbol";
} : function(a3) {
  var e = ql("Symbol");
  return Ql(e) && Kl(e.prototype, Jl(a3));
}, eh = String, Or = function(a3) {
  try {
    return eh(a3);
  } catch {
    return "Object";
  }
}, th = B, rh = Or, ah = TypeError, Te = function(a3) {
  if (th(a3)) return a3;
  throw new ah(rh(a3) + " is not a function");
}, ih = Te, nh = xr, st = function(a3, e) {
  var t = a3[e];
  return nh(t) ? void 0 : ih(t);
}, ra = Y, aa = B, ia = ae, sh = TypeError, oh = function(a3, e) {
  var t, r;
...
}, zo = { exports: {} }, Tn = _, uh = Object.defineProperty, Oi = function(a3, e) {
  try {
...
(Sn.versions || (Sn.versions = [])).push({ version: "3.48.0", mode: "global", copyright: "\xA9 2013\u20132025 Denis Pushkarev (zloirock.ru), 2025\u20132026 CoreJS Company (core-js.io). All rights reserved.", license: "https://github.com/zloirock/core-js/blob/v3.48.0/LICENSE", source: "https://github.com/zloirock/core-js" });
var Si = zo.exports, En = Si, Ei = function(a3, e) {
  return En[a3] || (En[a3] = e || {});
}, vh = ve, fh = Object, Sr = function(a3) {
  return fh(vh(a3));
}, ch = L, gh = Sr, dh = ch({}.hasOwnProperty), fe = Object.hasOwn || function(e, t) {
  return dh(gh(e), t);
}, ph = L, yh = 0, mh = Math.random(), bh = ph(1.1.toString), Ho = function(a3) {
  return "Symbol(" + (a3 === void 0 ? "" : a3) + ")_" + bh(++yh + mh, 36);
}, xh = _, Th = Ei, $n = fe, Oh = Ho, Sh = Fo, Eh = Uo, Ke = xh.Symbol, na = Th("wks"), $h = Eh ? Ke.for || Ke : Ke && Ke.withoutSetter || Oh, z = function(a3) {
  return $n(na, a3) || (na[a3] = Sh && $n(Ke, a3) ? Ke[a3] : $h("Symbol." + a3)), na[a3];
}, wh = Y, wn = ae, Cn = Go, Ch = st, Ah = oh, Ph = z, Rh = TypeError, Nh = Ph("toPrimitive"), Ih = function(a3, e) {
...
}, Mh = Ih, _h = Go, Yo = function(a3) {
  var e = Mh(a3, "string");
  return _h(e) ? e : e + "";
}, Vh = _, An = ae, Ya = Vh.document, Dh = An(Ya) && An(Ya.createElement), Er = function(a3) {
  return Dh ? Ya.createElement(a3) : {};
}, Lh = he, kh = D, Bh = Er, Xo = !Lh && !kh(function() {
  return Object.defineProperty(Bh("div"), "a", { get: function() {
    return 7;
  } }).a !== 7;
...
}), Qh = ae, Kh = String, Zh = TypeError, J = function(a3) {
  if (Qh(a3)) return a3;
...
Oe.f = Jh ? tv ? function(e, t, r) {
  if (Ut(e), t = Rn(t), Ut(r), typeof e == "function" && t === "prototype" && "value" in r && la in r && !r[la]) {
    var i = av(e, t);
    i && i[la] && (e[t] = r.value, r = { configurable: ua in r ? r[ua] : i[ua], enumerable: oa in r ? r[oa] : i[oa], writable: false });
  }
  return sa(e, t, r);
} : sa : function(e, t, r) {
...
var iv = he, nv = Oe, sv = xi, Ct = iv ? function(a3, e, t) {
...
}).name === "something", hv = Ko && (!Xa || Xa && uv(Qo, "name").configurable), $r = { PROPER: lv, CONFIGURABLE: hv }, vv = L, fv = B, Wa = Si, cv = vv(Function.toString);
fv(Wa.inspectSource) || (Wa.inspectSource = function(a3) {
  return cv(a3);
});
var $i = Wa.inspectSource, gv = _, dv = B, Nn = gv.WeakMap, pv = dv(Nn) && /native code/.test(String(Nn)), yv = Ei, mv = Ho, In = yv("keys"), wi = function(a3) {
  return In[a3] || (In[a3] = mv(a3));
}, Ci = {}, bv = pv, Zo = _, xv = ae, Tv = Ct, ha = fe, va = Si, Ov = wi, Sv = Ci, Mn = "Object already initialized", qa = Zo.TypeError, Ev = Zo.WeakMap, gr, Tt, dr, $v = function(a3) {
  return dr(a3) ? Tt(a3) : gr(a3, {});
}, wv = function(a3) {
  return function(e) {
    var t;
    if (!xv(e) || (t = Tt(e)).type !== a3) throw new qa("Incompatible receiver, " + a3 + " required");
    return t;
  };
};
if (bv || va.state) {
...
var wr = { set: gr, get: Tt, has: dr, enforce: $v, getterFor: wv }, Ai = L, Cv = D, Av = B, Gt = fe, Qa = he, Pv = $r.CONFIGURABLE, Rv = $i, Jo = wr, Nv = Jo.enforce, Iv = Jo.get, _n = String, or = Object.defineProperty, Mv = Ai("".slice), _v = Ai("".replace), Vv = Ai([].join), Dv = Qa && !Cv(function() {
  return or(function() {
  }, "length", { value: 8 }).length !== 8;
}), Lv = String(String).split("String"), kv = qo.exports = function(a3, e, t) {
...
var eu = qo.exports, Bv = B, jv = Oe, Fv = eu, Uv = Oi, Ue = function(a3, e, t, r) {
  r || (r = {});
  var i = r.enumerable, n = r.name !== void 0 ? r.name : e;
  if (Bv(t) && Fv(t, n, r), r.global) i ? a3[e] = t : Uv(e, t);
  else {
    try {
      r.unsafe ? a3[e] && (i = true) : delete a3[e];
    } catch {
    }
    i ? a3[e] = t : jv.f(a3, e, { value: t, enumerable: false, configurable: !r.nonConfigurable, writable: !r.nonWritable });
  }
  return a3;
}, tu = {}, Gv = Math.ceil, zv = Math.floor, Hv = Math.trunc || function(e) {
  var t = +e;
  return (t > 0 ? zv : Gv)(t);
}, Yv = Hv, Cr = function(a3) {
  var e = +a3;
  return e !== e || e === 0 ? 0 : Yv(e);
}, Xv = Cr, Wv = Math.max, qv = Math.min, Qv = function(a3, e) {
  var t = Xv(a3);
  return t < 0 ? Wv(t + e, 0) : qv(t, e);
}, Kv = Cr, Zv = Math.min, ot = function(a3) {
  var e = Kv(a3);
  return e > 0 ? Zv(e, 9007199254740991) : 0;
}, Jv = ot, Pi = function(a3) {
  return Jv(a3.length);
}, ef = $t, tf = Qv, rf = Pi, af = function(a3) {
...
}, ru = { indexOf: af(false) }, nf = L, fa = fe, sf = $t, of = ru.indexOf, uf = Ci, Vn = nf([].push), au = function(a3, e) {
  var t = sf(a3), r = 0, i = [], n;
  for (n in t) !fa(uf, n) && fa(t, n) && Vn(i, n);
  for (; e.length > r; ) fa(t, n = e[r++]) && (~of(i, n) || Vn(i, n));
  return i;
}, Ri = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"], lf = au, hf = Ri, vf = hf.concat("length", "prototype");
...
var ff = Fe, cf = L, gf = tu, df = iu, pf = J, yf = cf([].concat), mf = ff("Reflect", "ownKeys") || function(e) {
  ...
  return r ? yf(t, r(e)) : t;
}, Dn = fe, bf = mf, xf = Et, Tf = Oe, Of = function(a3, e, t) {
  for (var r = bf(e), i = Tf.f, n = xf.f, o = 0; o < r.length; o++) {
    var s = r[o];
    !Dn(a3, s) && !(t && Dn(t, s)) && i(a3, s, n(e, s));
  }
}, Sf = D, Ef = B, $f = /#|\.prototype\./, At = function(a3, e) {
  var t = Cf[wf(a3)];
  return t === Pf ? true : t === Af ? false : Ef(e) ? Sf(e) : !!e;
}, wf = At.normalize = function(a3) {
  return String(a3).replace($f, ".").toLowerCase();
}, Cf = At.data = {}, Af = At.NATIVE = "N", Pf = At.POLYFILL = "P", nu = At, zt = _, Rf = Et.f, Nf = Ct, If = Ue, Mf = Oi, _f = Of, Vf = nu, ee = function(a3, e) {
...
}, vt = _, Df = wt, Lf = je, Ht = function(a3) {
...
}(), kf = su, Ar = kf === "NODE", Bf = _, jf = Bf, Ff = L, Uf = Te, Gf = function(a3, e, t) {
  try {
    return Ff(Uf(Object.getOwnPropertyDescriptor(a3, e)[t]));
  } catch {
  }
}, zf = ae, Hf = function(a3) {
  return zf(a3) || a3 === null;
}, Yf = Hf, Xf = String, Wf = TypeError, qf = function(a3) {
  if (Yf(a3)) return a3;
...
}() : void 0), ec = Oe.f, tc = fe, rc = z, Ln = rc("toStringTag"), Pr = function(a3, e, t) {
  a3 && !t && (a3 = a3.prototype), a3 && !tc(a3, Ln) && ec(a3, Ln, { configurable: true, value: e });
}, kn = eu, ac = Oe, ic = function(a3, e, t) {
  return t.get && kn(t.get, e, { getter: true }), t.set && kn(t.set, e, { setter: true }), ac.f(a3, e, t);
}, nc = Fe, sc = ic, oc = z, uc = he, Bn = oc("species"), lc = function(a3) {
  var e = nc(a3);
  uc && e && !e[Bn] && sc(e, Bn, { configurable: true, get: function() {
    return this;
  } });
}, hc = Tr, vc = TypeError, fc = function(a3, e) {
...
var dc = String(uu) === "[object z]", pc = dc, yc = B, ur = je, mc = z, bc = mc("toStringTag"), xc = Object, Tc = ur(/* @__PURE__ */ function() {
  return arguments;
}()) === "Arguments", Oc = function(a3, e) {
  try {
    return a3[e];
  } catch {
  }
}, Ni = pc ? ur : function(a3) {
  var e, t, r;
...
}) ? fu : ft, Nc = Rc, Ic = Or, Mc = TypeError, _c = function(a3) {
  if (Nc(a3)) return a3;
  throw new Mc(Ic(a3) + " is not a constructor");
}, jn = J, Vc = _c, Dc = xr, Lc = z, kc = Lc("species"), cu = function(a3, e) {
...
}), jc = je, Fc = L, Rr = function(a3) {
  if (jc(a3) === "Function") return Fc(a3);
}, Gn = Rr, Uc = Te, Gc = br, zc = Gn(Gn.bind), Mi = function(a3, e) {
  return Uc(a3), e === void 0 ? a3 : Gc ? zc(a3, e) : function() {
    return a3.apply(e, arguments);
  };
}, Hc = Fe, pu = Hc("document", "documentElement"), Yc = L, Xc = Yc([].slice), Wc = TypeError, qc = function(a3, e) {
...
var bu = { set: Ka }, Zn = _, og = he, ug = Object.getOwnPropertyDescriptor, lg = function(a3) {
  if (!og) return Zn[a3];
  var e = ug(Zn, a3);
  return e && e.value;
}, xu = function() {
...
xt && xt.prototype;
var Cg = wg("species"), Ja = false, Ou = Sg(Og.PromiseRejectionEvent), Ag = Eg("Promise", function() {
...
}), Pt = { CONSTRUCTOR: Ag, REJECTION_EVENT: Ou, SUBCLASSING: Ja }, ut = {}, ns = Te, Pg = TypeError, Rg = function(a3) {
  var e, t;
...
var Ng = ee, pr = Ar, we = _, Ig = jf, it = Y, ss = Ue, os = ou, Mg = Pr, _g = lc, Vg = Te, lr = B, Dg = ae, Lg = fc, kg = cu, Su = bu.set, Di = bg, Bg = xg, jg = Vi, Fg = Tu, Eu = wr, yr = Nr, Li = Pt, $u = ut, Ir = "Promise", wu = Li.CONSTRUCTOR, Ug = Li.REJECTION_EVENT, Gg = Li.SUBCLASSING, Sa = Eu.getterFor(Ir), zg = Eu.set, qe = yr && yr.prototype, Le = yr, Qt = qe, Cu = we.TypeError, ei = we.document, ki = we.process, ti = $u.f, Hg = ti, Yg = !!(ei && ei.createEvent && we.dispatchEvent), Au = "unhandledrejection", Xg = "rejectionhandled", us = 0, Pu = 1, Wg = 2, Bi = 1, Ru = 2, Kt, ls, Nu, hs, Iu = function(a3) {
  ...
  a3.notified || (a3.notified = true, Di(function() {
    for (var t = a3.reactions, r; r = t.get(); ) Mu(r, a3);
  ...
  it(Su, we, function() {
    ...
    }), a3.rejection = pr || vs(a3) ? Ru : Bi, i.error)) throw i.value;
  });
}, vs = function(a3) {
...
if (wu && (Le = function(e) {
  ...
  zg(this, { type: Ir, done: false, notified: false, parent: false, reactions: new Fg(), rejection: false, state: us, value: null });
...
Ng({ global: true, constructor: true, wrap: true, forced: wu }, { Promise: Le });
Nu = Ig.Promise;
Mg(Le, Ir, false);
_g(Ir);
var Rt = {}, Kg = z, Zg = Rt, Jg = Kg("iterator"), ed = Array.prototype, td = function(a3) {
  return a3 !== void 0 && (Zg.Array === a3 || ed[Jg] === a3);
}, rd = Ni, fs = st, ad = xr, id = Rt, nd = z, sd = nd("iterator"), Du = function(a3) {
  if (!ad(a3)) return fs(a3, sd) || fs(a3, "@@iterator") || id[rd(a3)];
}, od = Y, ud = Te, ld = J, hd = Or, vd = Du, fd = TypeError, cd = function(a3, e) {
  var t = arguments.length < 2 ? vd(a3) : e;
  if (ud(t)) return ld(od(t, a3));
  throw new fd(hd(a3) + " is not iterable");
}, gd = Y, cs = J, dd = st, pd = function(a3, e, t) {
  var r, i;
  cs(a3);
  try {
    if (r = dd(a3, "return"), !r) {
  ...
  if (i) throw r;
  return cs(r), t;
}, yd = Mi, md = Y, bd = J, xd = Or, Td = td, Od = Pi, gs = Tr, Sd = cd, Ed = Du, ds = pd, $d = TypeError, hr = function(a3, e) {
  this.stopped = a3, this.result = e;
}, ps = hr.prototype, Lu = function(a3, e, t) {
  ...
  if (n) l = a3.iterator;
    ...
    if (Td(h)) {
      for (f = 0, c = Od(a3); c > f; f++) if (v = y(a3[f]), v && gs(ps, v)) return v;
      return new hr(false);
    }
    l = Sd(a3, h);
  }
  ...
  return new hr(false);
}, wd = z, ku = wd("iterator"), Bu = false;
try {
  var Cd = 0, ys = { next: function() {
    return { done: !!Cd++ };
  }, return: function() {
    Bu = true;
  } };
...
var Ad = function(a3, e) {
  ...
  return t;
}, Pd = Nr, Rd = Ad, Nd = Pt.CONSTRUCTOR, ju = Nd || !Rd(function(a3) {
  Pd.all(a3).then(void 0, function() {
  });
}), Id = ee, Md = Y, _d = Te, Vd = ut, Dd = Vi, Ld = Lu, kd = ju;
Id({ target: "Promise", stat: true, forced: kd }, { all: function(e) {
...
Bd({ target: "Promise", proto: true, forced: jd, real: true }, { catch: function(a3) {
...
zd({ target: "Promise", stat: true, forced: Qd }, { race: function(e) {
...
Kd({ target: "Promise", stat: true, forced: Jd }, { reject: function(e) {
  var t = Zd.f(this), r = t.reject;
  return r(e), t.promise;
} });
var ep = J, tp = ae, rp = ut, ap = function(a3, e) {
  if (ep(a3), tp(e) && e.constructor === a3) return e;
  var t = rp.f(a3), r = t.resolve;
  return r(e), t.promise;
}, ip = ee, np = Fe, sp = Pt.CONSTRUCTOR, op = ap;
np("Promise");
ip({ target: "Promise", stat: true, forced: sp }, { resolve: function(e) {
  return op(this, e);
} });
...
var up = Ni, lp = String, pe = function(a3) {
...
}), Uu = { BROKEN_CARET: fp, UNSUPPORTED_Y: Ui }, Gu = {}, cp = au, gp = Ri, dp = Object.keys || function(e) {
  return cp(e, gp);
...
qp && (si = function(e) {
  ...
  if (n) return n.lastIndex = t.lastIndex, o = Je(si, n, i), t.lastIndex = n.lastIndex, o;
...
`) && (p = "(?: " + p + ")", x = " " + x, y++), s = new RegExp("^(?:" + p + ")", d)), ui && (s = new RegExp("^" + p + "$(?!\\s)", d)), oi && (u = t.lastIndex), l = Je(mr, g ? s : t, x), g ? l ? (l.input = $a(l.input, y), l[0] = $a(l[0], y), l.index = t.lastIndex, t.lastIndex += l[0].length) : t.lastIndex = 0 : oi && l && (t.lastIndex = t.global ? l.index + l[0].length : u), ui && l && l.length > 1 && Je(Hp, l[0], s, function() {
  ...
  }), l && v) for (l.groups = f = Fp(null), h = 0; h < v.length; h++) c = v[h], f[c[0]] = l[c[1]];
  return l;
});
var zi = si, Qp = ee, $s = zi;
Qp({ target: "RegExp", proto: true, forced: /./.exec !== $s }, { exec: $s });
var ws = Y, Cs = Ue, Kp = zi, As = D, Xu = z, Zp = Ct, Jp = Xu("species"), wa = RegExp.prototype, Hi = function(a3, e, t, r) {
  ...
  r && Zp(wa[i], "sham", true);
}, Yi = L, ey = Cr, ty = pe, ry = ve, ay = Yi("".charAt), Ps = Yi("".charCodeAt), iy = Yi("".slice), ny = function(a3) {
  return function(e, t) {
...
}, sy = { charAt: ny(true) }, oy = sy.charAt, Xi = function(a3, e, t) {
  ...
  return s !== r || t !== r;
}), vy = { correct: hy }, fy = Y, cy = fe, gy = Tr, Ns = vy, dy = Fu, py = RegExp.prototype, Wi = Ns.correct ? function(a3) {
  return a3.flags;
} : function(a3) {
  return !Ns.correct && gy(py, a3) && !cy(a3, "flags") ? fy(dy, a3) : a3.flags;
}, Is = Y, yy = J, my = B, by = je, xy = zi, Ty = TypeError, qi = function(a3, e) {
  var t = a3.exec;
  if (my(t)) {
    var r = Is(t, a3, e);
...
var Qi = L, Iy = Sr, My = Math.floor, Ca = Qi("".charAt), _y = Qi("".replace), Aa = Qi("".slice), Vy = /\$([$&'`]|\d{1,2}|<[^>]*>)/g, Dy = /\$([$&'`]|\d{1,2})/g, Ly = function(a3, e, t, r, i, n) {
...
}, ky = du, Vs = Y, _r = L, By = Hi, jy = D, Fy = J, Uy = B, Gy = ae, zy = Cr, Hy = ot, Me = pe, Yy = ve, Xy = Xi, Wy = st, qy = Ly, Qy = Wi, Ky = qi, Zy = z, li = Zy("replace"), Jy = Math.max, em = Math.min, tm = _r([].concat), Pa = _r([].push), er = _r("".indexOf), Ds = _r("".slice), rm = function(a3) {
...
var nm = ae, sm = je, om = z, um = om("match"), lm = function(a3) {
  var e;
  return nm(a3) && ((e = a3[um]) !== void 0 ? !!e : sm(a3) === "RegExp");
}, hm = lm, vm = TypeError, Ki = function(a3) {
  if (hm(a3)) throw new vm("The method doesn't accept regular expressions");
  return a3;
}, fm = z, cm = fm("match"), Zi = function(a3) {
  var e = /./;
  try {
    "/./"[a3](e);
  } catch {
...
gm({ target: "String", proto: true, forced: !Sm && !Wu }, { startsWith: function(e) {
  var t = ks(bm(this));
  mm(e);
...
vi[hi] === void 0 && wm(vi, hi, { configurable: true, value: $m(null) });
var Cm = function(a3) {
  vi[hi][a3] = true;
}, Am = D, Pm = !Am(function() {
  function a3() {
...
}), Rm = fe, Nm = B, Im = Sr, Mm = wi, _m = Pm, Bs = Mm("IE_PROTO"), fi = Object, Vm = fi.prototype, qu = _m ? fi.getPrototypeOf : function(a3) {
  var e = Im(a3);
  if (Rm(e, Bs)) return e[Bs];
  var t = e.constructor;
  return Nm(t) && e instanceof t ? t.prototype : e instanceof fi ? Vm : null;
}, Dm = D, Lm = B, km = ae, js = qu, Bm = Ue, jm = z, ci = jm("iterator"), Qu = false, ke, Ra, Na;
...
var Ku = { IteratorPrototype: ke, BUGGY_SAFARI_ITERATORS: Qu }, Um = Ku.IteratorPrototype, Gm = Gi, zm = xi, Hm = Pr, Ym = Rt, Xm = function() {
  return this;
}, Wm = function(a3, e, t, r) {
  var i = e + " Iterator";
  ...
  if (v && (g = Fs(v.call(new a3())), g !== Object.prototype && g.next && (Fs(g) !== Gs && (Us ? Us(g, Gs) : Km(g[ct]) || Ia(g, ct, n0)), Jm(g, u, true))), a0 && i === gt && f && f.name !== gt && (i0 ? e0(h, "name", gt) : (l = true, c = function() {
    return Qm(f, this);
  })), i) if (d = { values: s(gt), keys: n ? c : s(zs), entries: s(Hs) }, o) for (p in d) (tr || l || !(p in h)) && Ia(h, p, d[p]);
  else qm({ target: e, proto: true, forced: tr || l }, d);
  return h[ct] !== c && Ia(h, ct, c, { name: i }), r0[e] = c, d;
}, o0 = function(a3, e) {
  return { value: a3, done: e };
}, u0 = $t, Ji = Cm, Ys = Rt, el = wr, l0 = Oe.f, h0 = s0, rr = o0, v0 = he, tl = "Array Iterator", f0 = el.set, c0 = el.getterFor(tl), g0 = h0(Array, "Array", function(a3, e) {
  f0(this, { type: tl, target: u0(a3), index: 0, kind: e });
}, function() {
...
for (var Da in rl) al(qs[Da] && qs[Da].prototype, Da);
al(m0, "DOMTokenList");
function T0(a3, e) {
  if (za(a3) != "object" || !a3) return a3;
...
function en(a3, e, t) {
  return (e = O0(e)) in a3 ? Object.defineProperty(a3, e, { value: t, enumerable: true, configurable: true, writable: true }) : a3[e] = t, a3;
}
var S0 = Te, E0 = Sr, $0 = Bo, w0 = Pi, Ks = TypeError, Zs = "Reduce of empty array with no initial value", C0 = function(a3) {
  return function(e, t, r, i) {
    ...
    if (r < 2) for (; ; ) {
      ...
      if (u += l, a3 ? u < 0 : s <= u) throw new Ks(Zs);
    }
    for (; a3 ? u >= 0 : s > u; u += l) u in o && (i = t(i, o[u], u, n));
    return i;
  };
}, A0 = { left: C0(false) }, P0 = D, il = function(a3, e) {
  var t = [][a3];
...
R0({ target: "Array", proto: true, forced: V0 }, { reduce: function(e) {
...
D0({ target: "String", proto: true, forced: !H0 && !nl }, { endsWith: function(e) {
  var t = eo(F0(this));
  j0(e);
...
}), ao = "abbc".split(/(b)*/)[1] === "c" || "test".split(/(?:)/, -1).length !== 4 || "ab".split(/(?:ab)*/).length !== 2 || ".".split(/(.?)(.?)/).length !== 4 || ".".split(/()()/).length > 1 || "".split(/.?/).length;
Y0("split", function(a3, e, t) {
  ...
  return [function(n, o) {
    ...
    for (var g = 0, d = 0, p = []; d < s.length; ) {
      ...
      if (y === null || (x = ab(Z0(c.lastIndex + (We ? d : 0)), s.length)) === g) d = K0(s, d, h);
      else {
...
var nb = yt.exports, sb = nb, be = typeof window > "u" ? Qe : window, ar = ["moz", "webkit"], tt = "AnimationFrame", nt = be["request" + tt], St = be["cancel" + tt] || be["cancelRequest" + tt];
for (var dt = 0; !nt && dt < ar.length; dt++) nt = be[ar[dt] + "Request" + tt], St = be[ar[dt] + "Cancel" + tt] || be[ar[dt] + "CancelRequest" + tt];
if (!nt || !St) {
  var ja = 0, io = 0, _e = [], ob = 1e3 / 60;
  nt = function(a3) {
    if (_e.length === 0) {
    ...
    return _e.push({ handle: ++io, callback: a3, cancelled: false }), io;
  }, St = function(a3) {
...
const Fa = Io(ub);
var ol = `	
\v\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF`, lb = L, hb = ve, vb = pe, gi = ol, no = lb("".replace), fb = RegExp("^[" + gi + "]+"), cb = RegExp("(^|[^" + gi + "])[" + gi + "]+$"), gb = function(a3) {
  return function(e) {
    var t = vb(hb(e));
    return a3 & 1 && (t = no(t, fb, "")), a3 & 2 && (t = no(t, cb, "$1")), t;
  };
}, db = { trim: gb(3) }, pb = $r.PROPER, yb = D, so = ol, oo = "\u200B\x85\u180E", mb = function(a3) {
  return yb(function() {
    return !!so[a3]() || oo[a3]() !== oo || pb && so[a3].name !== a3;
  });
}, bb = ee, xb = db.trim, Tb = mb;
bb({ target: "String", proto: true, forced: Tb("trim") }, { trim: function() {
  return xb(this);
} });
var Ob = function(a3) {
  ...
  a3 = e[a3] || a3;
  for (var t = [{ re: /^rgba\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3}),\s*((?:\d?\.)?\d)\)$/, example: ["rgba(123, 234, 45, 0.8)", "rgba(255,234,245,1.0)"], process: function(u) {
    return [parseInt(u[1]), parseInt(u[2]), parseInt(u[3]), parseFloat(u[4])];
  } }, { re: /^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/, example: ["rgb(123, 234, 45)", "rgb(255,234,245)"], process: function(u) {
    return [parseInt(u[1]), parseInt(u[2]), parseInt(u[3])];
  } }, { re: /^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/, example: ["#00ff00", "336699"], process: function(u) {
    return [parseInt(u[1], 16), parseInt(u[2], 16), parseInt(u[3], 16)];
  } }, { re: /^([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, example: ["#fb0", "f0f"], process: function(u) {
...
const di = Io(Ob);
var Sb = ee, Eb = Rr, $b = ru.indexOf, wb = il, pi = Eb([].indexOf), ul = !!pi && 1 / pi([1], 1, -0) < 0, Cb = ul || !wb("indexOf");
Sb({ target: "Array", proto: true, forced: Cb }, { indexOf: function(e) {
  var t = arguments.length > 1 ? arguments[1] : void 0;
  return ul ? pi(this, e, t) || 0 : $b(this, e, t);
} });
var Ab = ee, Pb = L, Rb = Ki, Nb = ve, uo = pe, Ib = Zi, Mb = Pb("".indexOf);
Ab({ target: "String", proto: true, forced: !Ib("includes") }, { includes: function(e) {
  return !!~Mb(uo(Nb(this)), uo(Rb(e)), arguments.length > 1 ? arguments[1] : void 0);
} });
var _b = je, Vb = Array.isArray || function(e) {
  return _b(e) === "Array";
}, Db = ee, Lb = L, kb = Vb, Bb = Lb([].reverse), lo = [1, 2];
Db({ target: "Array", proto: true, forced: String(lo) === String(lo.reverse()) }, { reverse: function() {
...
function Ua(a3, e, t) {
  ...
  var s = yi([(e - n) / 2, (t - o) / 2], -a3.xRot / 180 * Ee), u = s[0], l = s[1], h = Math.pow(u, 2) / Math.pow(r, 2) + Math.pow(l, 2) / Math.pow(i, 2);
  1 < h && (r *= Math.sqrt(h), i *= Math.sqrt(h)), a3.rX = r, a3.rY = i;
  var f = Math.pow(r, 2) * Math.pow(l, 2) + Math.pow(i, 2) * Math.pow(u, 2), c = (a3.lArcFlag !== a3.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(r, 2) * Math.pow(i, 2) - f) / f)), v = r * l / i * c, g = -i * u / r * c, d = yi([v, g], a3.xRot / 180 * Ee);
  ...
  a3.ROUND = function(s) {
    ...
    var s = function(c) {
      ...
      if (d.type & m.DRAWING_COMMANDS && (p(v), y(g)), d.type & m.HORIZ_LINE_TO && p(d.x), d.type & m.VERT_LINE_TO && y(d.y), d.type & m.LINE_TO && (p(d.x), y(d.y)), d.type & m.CURVE_TO) {
        p(d.x), y(d.y);
        for (var x = 0, b = co(v, d.x1, d.x2, d.x); x < b.length; x++) 0 < (N = b[x]) && 1 > N && p(go(v, d.x1, d.x2, d.x, N));
        for (var T = 0, $ = co(g, d.y1, d.y2, d.y); T < $.length; T++) 0 < (N = $[T]) && 1 > N && y(go(g, d.y1, d.y2, d.y, N));
      }
      if (d.type & m.ARC) {
        ...
        }, G = 0, q = ho(P, -O, 0).map(W); G < q.length; G++) (N = q[G]) > R && N < X && p(fo(d.cX, O, P, N));
...
}(vl), Gb = ((oe = {})[m.MOVE_TO] = 2, oe[m.LINE_TO] = 2, oe[m.HORIZ_LINE_TO] = 1, oe[m.VERT_LINE_TO] = 1, oe[m.CLOSE_PATH] = 0, oe[m.QUAD_TO] = 4, oe[m.SMOOTH_QUAD_TO] = 2, oe[m.CURVE_TO] = 6, oe[m.SMOOTH_CURVE_TO] = 4, oe[m.ARC] = 7, oe), zb = $r.PROPER, Hb = Ue, Yb = J, yo = pe, Xb = D, Wb = Wi, tn = "toString", fl = RegExp.prototype, cl = fl[tn], qb = Xb(function() {
...
function r1(a3, e, t, r, i, n) {
  for (var o = a3.data, s = 2 * n + 1, u = r - 1, l = i - 1, h = n + 1, f = h * (h + 1) / 2, c = new mo(), v = c, g, d = 1; d < s; d++) v = v.next = new mo(), d === h && (g = v);
  v.next = c;
  ...
  for (var He = 0; He < r; He++) {
    ...
    v = c;
    for (var fn = 0; fn < h; fn++) v.r = Pe, v.g = Re, v.b = Ne, v.a = te, v = v.next;
...
function a1() {
  var { DOMParser: a3 } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, e = { window: null, ignoreAnimation: true, ignoreMouse: true, DOMParser: a3, createCanvas(t, r) {
...
function i1(a3) {
  var { DOMParser: e, canvas: t, fetch: r } = a3;
  return { window: null, ignoreAnimation: true, ignoreMouse: true, DOMParser: e, fetch: r, createCanvas: t.createCanvas, createImage: t.loadImage };
}
var D2 = Object.freeze({ __proto__: null, offscreen: a1, node: i1 });
function lt(a3) {
...
var h1 = /(\[[^\]]+\])/g, v1 = /(#[^\s+>~.[:]+)/g, f1 = /(\.[^\s+>~.[:]+)/g, c1 = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi, g1 = /(:[\w-]+\([^)]*\))/gi, d1 = /(:[^\s+>~.[:]+)/g, p1 = /([^\s+>~.[:]+)/g;
function Ve(a3, e) {
  var t = e.exec(a3);
...
class S {
  ...
  split() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : " ", { document: t, name: r } = this;
  ...
  isString(e) {
    var { value: t } = this, r = typeof t == "string";
  ...
  getNumber(e) {
    ...
    var { value: t } = this, r = parseFloat(t);
...
S.textBaselineMapping = { baseline: "alphabetic", "before-edge": "top", "text-before-edge": "top", middle: "middle", central: "middle", "after-edge": "bottom", "text-after-edge": "bottom", ideographic: "ideographic", alphabetic: "alphabetic", hanging: "hanging", mathematical: "alphabetic" };
class m1 {
  constructor() {
    this.viewPorts = [];
  }
...
class k {
  ...
  applyTransform(e) {
    var { x: t, y: r } = this, i = t * e[0] + r * e[2] + e[4], n = t * e[1] + r * e[3] + e[5];
    this.x = i, this.y = n;
  }
}
class b1 {
  ...
  start() {
    if (!this.working) {
      var { screen: e, onClick: t, onMouseMove: r } = this, i = e.ctx.canvas;
  ...
  runEvents() {
    if (this.working) {
      var { screen: e, events: t, eventElements: r } = this, { style: i } = e.ctx.canvas;
  ...
  mapXY(e, t) {
    for (var { window: r, ctx: i } = this.screen, n = new k(e, t), o = i.canvas; o; ) n.x -= o.offsetLeft, n.y -= o.offsetTop, o = o.offsetParent;
    return r.scrollX && (n.x += r.scrollX), r.scrollY && (n.y += r.scrollY), n;
  }
  onClick(e) {
    var { x: t, y: r } = this.mapXY(e.clientX, e.clientY);
    this.events.push({ type: "onclick", x: t, y: r, run(i) {
      i.onClick && i.onClick();
    } });
  }
  onMouseMove(e) {
    var { x: t, y: r } = this.mapXY(e.clientX, e.clientY);
    this.events.push({ type: "onmousemove", x: t, y: r, run(i) {
...
class Dr {
  constructor(e) {
    var { fetch: t = pl, window: r = dl } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  ...
  setViewBox(e) {
    var { document: t, ctx: r, aspectRatio: i, width: n, desiredWidth: o, height: s, desiredHeight: u, minX: l = 0, minY: h = 0, refX: f, refY: c, clip: v = false, clipX: g = 0, clipY: d = 0 } = e, p = lt(i).replace(/^defer\s/, ""), [y, x] = p.split(" "), b = y || "xMidYMid", T = x || "meet", $ = n / o, E = s / u, O = Math.min($, E), C = Math.max($, E), P = o, V = u;
  ...
  start(e) {
    var { enableRedraw: t = false, ignoreMouse: r = false, ignoreAnimation: i = false, ignoreDimensions: n = false, ignoreClear: o = false, forceRedraw: s, scaleWidth: u, scaleHeight: l, offsetX: h, offsetY: f } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, { FRAMERATE: c, mouse: v } = this, g = 1e3 / c;
  ...
  shouldUpdate(e, t) {
    if (!e) {
      var { frameDuration: r } = this, i = this.animations.reduce((n, o) => o.update(r) || n, false);
      if (i) return true;
    }
    return !!(typeof t == "function" && t() || !this.isReadyLock && this.isReady() || this.mouse.hasEvents());
  }
  render(e, t, r, i, n, o, s) {
    var { CLIENT_WIDTH: u, CLIENT_HEIGHT: l, viewPort: h, ctx: f, isFirstRender: c } = this, v = f.canvas;
...
Dr.defaultWindow = dl;
Dr.defaultFetch = pl;
var { defaultFetch: x1 } = Dr, T1 = typeof DOMParser < "u" ? DOMParser : null;
class Ga {
  constructor() {
    var { fetch: e = x1, DOMParser: t = T1 } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
class S1 {
  ...
  apply(e) {
    var { cx: t, cy: r, originX: i, originY: n, angle: o } = this, s = t + i.getPixels("x"), u = r + n.getPixels("y");
  ...
  applyToPoint(e) {
    var { cx: t, cy: r, angle: i } = this, n = i.getRadians();
    e.applyTransform([1, 0, 0, 1, t || 0, r || 0]), e.applyTransform([Math.cos(n), Math.sin(n), -Math.sin(n), Math.cos(n), 0, 0]), e.applyTransform([1, 0, 0, 1, -t || 0, -r || 0]);
  }
}
class E1 {
  constructor(e, t, r) {
  ...
  apply(e) {
    var { scale: { x: t, y: r }, originX: i, originY: n } = this, o = i.getPixels("x"), s = n.getPixels("y");
...
class yl {
  ...
  apply(e) {
    var { originX: t, originY: r, matrix: i } = this, n = t.getPixels("x"), o = r.getPixels("y");
    e.translate(n, o), e.transform(i[0], i[1], i[2], i[3], i[4], i[5]), e.translate(-n, -o);
  }
  unapply(e) {
    var { originX: t, originY: r, matrix: i } = this, n = i[0], o = i[2], s = i[4], u = i[1], l = i[3], h = i[5], f = 0, c = 0, v = 1, g = 1 / (n * (l * v - h * c) - o * (u * v - h * f) + s * (u * c - l * f)), d = t.getPixels("x"), p = r.getPixels("y");
...
class Be {
  constructor(e, t, r) {
    ...
    i.forEach((n) => {
      if (n !== "none") {
        var [o, s] = A1(n), u = Be.transformTypes[o];
...
Be.transformTypes = { translate: O1, rotate: S1, scale: E1, matrix: yl, skewX: $1, skewY: w1 };
class I {
  constructor(e, t) {
    ...
    if (this.document = e, this.node = t, this.captureTextNodes = r, this.attributes = /* @__PURE__ */ Object.create(null), this.styles = /* @__PURE__ */ Object.create(null), this.stylesSpecificity = /* @__PURE__ */ Object.create(null), this.animationFrozen = false, this.animationFrozenValue = "", this.parent = null, this.children = [], !(!t || t.nodeType !== 1)) {
      ...
      var { definitions: n } = e, o = this.getAttribute("id");
...
class Z {
  ...
  static parse() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "", t = arguments.length > 1 ? arguments[1] : void 0, r = "", i = "", n = "", o = "", s = "", u = lt(e).trim().split(" "), l = { fontSize: false, fontStyle: false, fontWeight: false, fontVariant: false };
    return u.forEach((h) => {
      switch (true) {
  ...
  toString() {
    return [I1(this.fontStyle), this.fontVariant, M1(this.fontWeight), this.fontSize, N1(this.fontFamily)].join(" ").trim();
  }
}
...
class w extends m {
  ...
  getReflectedControlPoint() {
    ...
    var { current: { x: t, y: r }, control: { x: i, y: n } } = this, o = new k(2 * t - i, 2 * r - n);
    return o;
  }
  makeAbsolute(e) {
  ...
  getMarkerAngles() {
    for (var { angles: e } = this, t = e.length, r = 0; r < t; r++) if (!e[r]) {
...
class A extends Ge {
  ...
  path(e) {
    var { pathParser: t } = this, r = new ce();
  ...
  getMarkers() {
    var { pathParser: e } = this, t = e.getMarkerPoints(), r = e.getMarkerAngles(), i = t.map((n, o) => [n, r[o]]);
    return i;
  }
  renderChildren(e) {
  ...
  pathM(e, t) {
    var { pathParser: r } = this, { point: i } = A.pathM(r), { x: n, y: o } = i;
    r.addMarker(i), t.addPoint(n, o), e && e.moveTo(n, o);
  }
  static pathL(e) {
    var { current: t } = e, r = e.getAsCurrentPoint();
    return { current: t, point: r };
  }
  pathL(e, t) {
    var { pathParser: r } = this, { current: i, point: n } = A.pathL(r), { x: o, y: s } = n;
    r.addMarker(n, i), t.addPoint(o, s), e && e.lineTo(o, s);
  }
  static pathH(e) {
    var { current: t, command: r } = e, i = new k((r.relative ? t.x : 0) + r.x, t.y);
    return e.current = i, { current: t, point: i };
  }
  pathH(e, t) {
    var { pathParser: r } = this, { current: i, point: n } = A.pathH(r), { x: o, y: s } = n;
    r.addMarker(n, i), t.addPoint(o, s), e && e.lineTo(o, s);
  }
  static pathV(e) {
    var { current: t, command: r } = e, i = new k(t.x, (r.relative ? t.y : 0) + r.y);
    return e.current = i, { current: t, point: i };
  }
  pathV(e, t) {
    var { pathParser: r } = this, { current: i, point: n } = A.pathV(r), { x: o, y: s } = n;
    r.addMarker(n, i), t.addPoint(o, s), e && e.lineTo(o, s);
  }
  static pathC(e) {
    var { current: t } = e, r = e.getPoint("x1", "y1"), i = e.getAsControlPoint("x2", "y2"), n = e.getAsCurrentPoint();
    return { current: t, point: r, controlPoint: i, currentPoint: n };
  }
  pathC(e, t) {
    var { pathParser: r } = this, { current: i, point: n, controlPoint: o, currentPoint: s } = A.pathC(r);
    r.addMarker(s, o, n), t.addBezierCurve(i.x, i.y, n.x, n.y, o.x, o.y, s.x, s.y), e && e.bezierCurveTo(n.x, n.y, o.x, o.y, s.x, s.y);
  }
  static pathS(e) {
    var { current: t } = e, r = e.getReflectedControlPoint(), i = e.getAsControlPoint("x2", "y2"), n = e.getAsCurrentPoint();
    return { current: t, point: r, controlPoint: i, currentPoint: n };
  }
  pathS(e, t) {
    var { pathParser: r } = this, { current: i, point: n, controlPoint: o, currentPoint: s } = A.pathS(r);
    r.addMarker(s, o, n), t.addBezierCurve(i.x, i.y, n.x, n.y, o.x, o.y, s.x, s.y), e && e.bezierCurveTo(n.x, n.y, o.x, o.y, s.x, s.y);
  }
  static pathQ(e) {
    var { current: t } = e, r = e.getAsControlPoint("x1", "y1"), i = e.getAsCurrentPoint();
    return { current: t, controlPoint: r, currentPoint: i };
  }
  pathQ(e, t) {
    var { pathParser: r } = this, { current: i, controlPoint: n, currentPoint: o } = A.pathQ(r);
    r.addMarker(o, n, n), t.addQuadraticCurve(i.x, i.y, n.x, n.y, o.x, o.y), e && e.quadraticCurveTo(n.x, n.y, o.x, o.y);
  }
  static pathT(e) {
    var { current: t } = e, r = e.getReflectedControlPoint();
    e.control = r;
    var i = e.getAsCurrentPoint();
    return { current: t, controlPoint: r, currentPoint: i };
  }
  pathT(e, t) {
    var { pathParser: r } = this, { current: i, controlPoint: n, currentPoint: o } = A.pathT(r);
    r.addMarker(o, n, n), t.addQuadraticCurve(i.x, i.y, n.x, n.y, o.x, o.y), e && e.quadraticCurveTo(n.x, n.y, o.x, o.y);
  }
  static pathA(e) {
    var { current: t, command: r } = e, { rX: i, rY: n, xRot: o, lArcFlag: s, sweepFlag: u } = r, l = o * (Math.PI / 180), h = e.getAsCurrentPoint(), f = new k(Math.cos(l) * (t.x - h.x) / 2 + Math.sin(l) * (t.y - h.y) / 2, -Math.sin(l) * (t.x - h.x) / 2 + Math.cos(l) * (t.y - h.y) / 2), c = Math.pow(f.x, 2) / Math.pow(i, 2) + Math.pow(f.y, 2) / Math.pow(n, 2);
    ...
    return mi(y, x) <= -1 && (b = Math.PI), mi(y, x) >= 1 && (b = 0), { currentPoint: h, rX: i, rY: n, sweepFlag: u, xAxisRotation: l, centp: d, a1: p, ad: b };
  }
  pathA(e, t) {
    var { pathParser: r } = this, { currentPoint: i, rX: n, rY: o, sweepFlag: s, xAxisRotation: u, centp: l, a1: h, ad: f } = A.pathA(r), c = 1 - s ? 1 : -1, v = h + c * (f / 2), g = new k(l.x + n * Math.cos(v), l.y + o * Math.sin(v));
...
class Ce extends Ge {
  constructor(e, t, r) {
    super(e, t, new.target === Ce ? true : r), this.type = "text", this.x = 0, this.y = 0, this.measureCache = -1;
  }
  setContext(e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
  ...
  getFontSize() {
    var { document: e, parent: t } = this, r = Z.parse(e.ctx.font).fontSize, i = t.getStyle("font-size").getNumber(r);
    return i;
  }
  ...
  getTextFromNode(e) {
    var t = e || this.node, r = Array.from(t.parentNode.childNodes), i = r.indexOf(t), n = r.length - 1, o = lt(t.textContent || "");
  ...
  renderTElementChildren(e) {
    var { document: t, parent: r } = this, i = this.getText(), n = r.getStyle("font-family").getDefinition();
    if (n) {
      for (var { unitsPerEm: o } = n.fontFace, s = Z.parse(t.ctx.font), u = r.getStyle("font-size").getNumber(s.fontSize), l = r.getStyle("font-style").getString(s.fontStyle), h = u / o, f = n.isRTL ? i.split("").reverse().join("") : i, c = ne(r.getAttribute("dx").getString()), v = f.length, g = 0; g < v; g++) {
...
class Lr extends Ce {
  constructor(e, t, r) {
    super(e, t, new.target === Lr ? true : r), this.type = "tspan", this.text = this.children.length > 0 ? "" : this.getTextFromNode();
  }
  getText() {
    return this.text;
  }
...
class Nt extends Ge {
  ...
  setContext(e) {
    var t, { document: r } = this, { screen: i, window: n } = r, o = e.canvas;
    ...
    v && (d = v[0], p = v[1]), this.root || (u = this.getStyle("width").getPixels("x"), l = this.getStyle("height").getPixels("y"), this.type === "marker" && (y = d, x = p, d = 0, p = 0)), i.viewPort.setCurrent(u, l), this.node && (!this.parent || ((t = this.node.parentNode) === null || t === void 0 ? void 0 : t.nodeName) === "foreignObject") && this.getStyle("transform", false, true).hasValue() && !this.getStyle("transform-origin", false, true).hasValue() && this.getStyle("transform-origin", true, true).setValue("50% 50%"), super.setContext(e), e.translate(this.getAttribute("x").getPixels("x"), this.getAttribute("y").getPixels("y")), v && (u = v[2], l = v[3]), r.setViewBox({ ctx: e, aspectRatio: this.getAttribute("preserveAspectRatio").getString(), width: i.viewPort.width, desiredWidth: u, height: i.viewPort.height, desiredHeight: l, minX: d, minY: p, refX: h.getValue(), refY: f.getValue(), clip: g, clipX: y, clipY: x }), v && (i.viewPort.removeCurrent(), i.viewPort.setCurrent(u, l));
  }
  clearContext(e) {
...
class Tl extends A {
  ...
  path(e) {
    var { points: t } = this, [{ x: r, y: i }] = t, n = new ce(r, i);
  ...
  getMarkers() {
    var { points: e } = this, t = e.length - 1, r = [];
...
class k1 extends Tl {
  ...
  path(e) {
    var t = super.path(e), [{ x: r, y: i }] = this.points;
...
class j1 extends I {
  ...
  render(e, t, r) {
    if (t) {
      var { x: i, y: n } = t, o = this.getAttribute("orient").getString("auto"), s = this.getAttribute("markerUnits").getString("strokeWidth");
...
class Ol extends I {
  ...
  createGradient(e, t, r) {
    ...
    var { stops: n } = i, o = this.getGradient(e, t);
    if (!o) return this.addParentOpacity(r, n[n.length - 1].color);
    if (n.forEach((p) => {
      o.addColorStop(p.offset, this.addParentOpacity(r, p.color));
    }), this.getAttribute("gradientTransform").hasValue()) {
      var { document: s } = this, { MAX_VIRTUAL_PIXELS: u, viewPort: l } = s.screen, [h] = l.viewPorts, f = new xl(s, null);
...
class an extends I {
  ...
  calcValue() {
    var { initialUnits: e } = this, { progress: t, from: r, to: i } = this.getProgress(), n = r.getNumber() + (i.getNumber() - r.getNumber()) * t;
    return e === "%" && (n *= 100), "".concat(n).concat(e);
  }
  update(e) {
    var { parent: t } = this, r = this.getProperty();
  ...
  getProgress() {
    var { document: e, values: t } = this, r = { progress: (this.duration - this.begin) / (this.maxDuration - this.begin) };
    if (t.hasValue()) {
...
class H1 extends an {
  ...
  calcValue() {
    var { progress: e, from: t, to: r } = this.getProgress(), i = new di(t.getColor()), n = new di(r.getColor());
    if (i.ok && n.ok) {
...
class Y1 extends an {
  ...
  calcValue() {
    var { progress: e, from: t, to: r } = this.getProgress(), i = ne(t.getString()), n = ne(r.getString()), o = i.map((s, u) => {
      var l = n[u];
      return s + (l - s) * e;
    }).join(" ");
    return o;
...
class X1 extends I {
  constructor(e, t, r) {
    ...
    var { definitions: i } = e, { children: n } = this;
...
class K1 extends Ce {
  constructor(e, t, r) {
    ...
    var { childNodes: i } = t, n = i[0], o = i.length > 0 && Array.from(i).every((s) => s.nodeType === 3);
  ...
  renderChildren(e) {
    if (this.hasText) {
      ...
      var { document: t, x: r, y: i } = this, { mouse: n } = t.screen, o = new S(t, "fontSize", Z.parse(t.ctx.font).fontSize);
...
class Z1 extends Ce {
  ...
  renderChildren(e) {
    ...
    var t = this.parent.getStyle("text-decoration").getString(), r = this.getFontSize(), { glyphInfo: i } = this, n = e.fillStyle;
  ...
  findSegmentToFitChar(e, t, r, i, n, o, s, u, l) {
    ...
    var c = this.textHeight / 20, v = this.getEquidistantPointOnPath(h, c, 0), g = this.getEquidistantPointOnPath(h + f, c, 0), d = { p0: v, p1: g }, p = v && g ? Math.atan2(g.y - v.y, g.x - v.x) : 0;
    if (s) {
      var y = Math.cos(Math.PI / 2 + p) * s, x = Math.cos(-p) * s;
      d.p0 = ir(ir({}, v), {}, { x: v.x + y, y: v.y + x }), d.p1 = ir(ir({}, g), {}, { x: g.x + y, y: g.y + x });
    }
    return h += f, { offset: h, segment: d, rotation: p };
  }
  measureText(e, t) {
    var { measuresCache: r } = this, i = t || this.getText();
  ...
  setTextData(e) {
    if (!this.glyphInfo) {
      ...
      (s === "middle" || s === "center") && (b = -p / 2), (s === "end" || s === "right") && (b = -p), b += x, r.forEach((T, $) => {
        var { offset: E, segment: O, rotation: C } = this.findSegmentToFitChar(e, s, p, y, i, b, o, T, $);
        b = E, !(!O.p0 || !O.p1) && this.glyphInfo.push({ text: r[$], p0: O.p0, p1: O.p1, rotation: C });
      });
    }
  }
  parsePathData(e) {
    if (this.pathLength = -1, !e) return [];
    var t = [], { pathParser: r } = e;
    for (r.reset(); !r.isEnd(); ) {
      var { current: i } = r, n = i ? i.x : 0, o = i ? i.y : 0, s = r.next(), u = s.type, l = [];
      switch (s.type) {
        case w.MOVE_TO:
          this.pathM(r, l);
          break;
      ...
      s.type !== w.CLOSE_PATH ? t.push({ type: u, points: l, start: { x: n, y: o }, pathLength: this.calcLength(n, o, u, l) }) : t.push({ type: w.CLOSE_PATH, points: [], pathLength: 0 });
    }
    return t;
  }
  pathM(e, t) {
  ...
  getPointOnLine(e, t, r, i, n) {
    ...
    var h = u * l, f = null;
    if (i === t) f = { x: o, y: s + h };
    else if ((s - r) / (o - t + rt) === u) f = { x: o + l, y: s + h };
    else {
  ...
  getPointOnEllipticalArc(e, t, r, i, n, o) {
    var s = Math.cos(o), u = Math.sin(o), l = { x: r * Math.cos(n), y: i * Math.sin(n) };
  ...
  buildEquidistantCache(e, t) {
    ...
    if (!this.equidistantCache || this.equidistantCache.step !== n || this.equidistantCache.precision !== i) {
      ...
      for (var o = 0, s = 0; s <= r; s += i) {
        ...
        !u || !l || (o += this.getLineLength(u.x, u.y, l.x, l.y), o >= n && (this.equidistantCache.points.push({ x: u.x, y: u.y, distance: s }), o -= n));
      }
    }
  }
...
class e2 extends Ge {
  ...
  renderChildren(e) {
    var { document: t, image: r, loaded: i } = this, n = this.getAttribute("x").getPixels("x"), o = this.getAttribute("y").getPixels("y"), s = this.getStyle("width").getPixels("x"), u = this.getStyle("height").getPixels("y");
    if (!(!i || !r || !s || !u)) {
      if (e.save(), e.translate(n, o), this.isSvg) {
        var l = t.canvg.forkString(e, this.image, { ignoreMouse: true, ignoreAnimation: true, ignoreDimensions: true, ignoreClear: true, offsetX: 0, offsetY: 0, scaleWidth: s, scaleHeight: u });
        l.document.documentElement.parent = this, l.render();
      } else {
        var h = this.image;
        t.setViewBox({ ctx: e, aspectRatio: this.getAttribute("preserveAspectRatio").getString(), width: s, desiredWidth: h.width, height: u, desiredHeight: h.height }), this.loaded && (typeof h.complete > "u" || h.complete) && e.drawImage(h, 0, 0);
      }
      e.restore();
    }
  }
...
class r2 {
  ...
  load(e, t) {
    ...
    return xe(function* () {
      try {
        var { document: i } = r, n = yield i.canvg.parser.load(t), o = n.getElementsByTagName("font");
...
class El extends I {
  ...
  apply(e, t, r, i, n) {
    for (var { includeOpacity: o, matrix: s } = this, u = e.getImageData(0, 0, i, n), l = 0; l < n; l++) for (var h = 0; h < i; h++) {
...
class kr extends I {
  ...
  apply(e, t) {
    var { document: r } = this, i = this.getAttribute("x").getPixels("x"), n = this.getAttribute("y").getPixels("y"), o = this.getStyle("width").getPixels("x"), s = this.getStyle("height").getPixels("y");
    if (!o && !s) {
      var u = new ce();
    ...
    r.screen.setDefaults(f), this.renderChildren(f), new El(r, { nodeType: 1, childNodes: [], attributes: [{ nodeName: "type", value: "luminanceToAlpha" }, { nodeName: "includeOpacity", value: "true" }] }).apply(f, 0, 0, i + o, n + s);
...
class i2 extends I {
  ...
  apply(e) {
    var { document: t } = this, r = Reflect.getPrototypeOf(e), { beginPath: i, closePath: n } = e;
...
class Br extends I {
  ...
  apply(e, t) {
    var { document: r, children: i } = this, n = t.getBoundingBox(e);
    if (n) {
      var o = 0, s = 0;
      i.forEach((y) => {
...
class u2 extends I {
  ...
  apply(e, t, r, i, n) {
    var { document: o, blurRadius: s } = this, u = o.window ? o.window.document.body : null, l = e.canvas;
...
class $e {
  constructor(e) {
    var { rootEmSize: t = 12, emSize: r = 12, createCanvas: i = $e.createCanvas, createImage: n = $e.createImage, anonymousCrossOrigin: o } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  ...
  setViewBox(e) {
    this.screen.setViewBox(f2({ document: this }, e));
  }
}
$e.createCanvas = c2;
$e.createImage = g2;
...
class mt {
  ...
  render() {
    ...
    return xe(function* () {
      ...
      t.start(De({ enableRedraw: true, ignoreAnimation: true, ignoreMouse: true }, r)), yield t.ready(), t.stop();
    })();
  }
  start() {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { documentElement: t, screen: r, options: i } = this;
    r.start(t, De(De({ enableRedraw: true }, i), e));
  }
  stop() {
    this.screen.stop();
  }
