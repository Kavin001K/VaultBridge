...
function He(s, a = []) {
  ...
  function p(b, h) {
    ...
    const D = (k) => {
      var _a;
      const { scope: P, children: j, ...E } = k, N = ((_a = P == null ? void 0 : P[s]) == null ? void 0 : _a[x]) || d, R = o.useMemo(() => E, Object.values(E));
      return e.jsx(N.Provider, { value: R, children: j });
    };
    D.displayName = b + "Provider";
    function $(k, P) {
      var _a;
      const j = ((_a = P == null ? void 0 : P[s]) == null ? void 0 : _a[x]) || d, E = o.useContext(j);
      if (E) return E;
...
var Ke = ["a", "button", "div", "form", "h2", "h3", "img", "input", "label", "li", "nav", "ol", "p", "select", "span", "svg", "ul"], ge = Ke.reduce((s, a) => {
  ...
  (l || l === 0) && !ue(l) && console.error(Je(`${l}`, "Progress"));
  const d = ue(l) ? l : ie;
  p !== null && !xe(p, d) && console.error(Ye(`${p}`, "Progress"));
  const x = xe(p, d) ? p : null, D = Z(x) ? b(x, d) : void 0;
  return e.jsx(Xe, { scope: u, value: x, max: d, children: e.jsx(ge.div, { "aria-valuemax": d, "aria-valuemin": 0, "aria-valuenow": Z(x) ? x : void 0, "aria-valuetext": D, role: "progressbar", "data-state": ye(x, d), "data-value": x ?? void 0, "data-max": d, ...h, ref: a }) });
});
we.displayName = ne;
...
function tt({ vaultId: s, shortCode: a, fullLink: u, filesCount: p, totalSize: l, expiresAt: b, downloads: h, maxDownloads: d, onSendEmail: x, className: D, minimal: $ = false }) {
  const [k, P] = o.useState(false), [j, E] = o.useState(false), [N, R] = o.useState(null), [M, B] = o.useState(""), [T, y] = o.useState(false), { toast: U } = he();
  o.useEffect(() => {
    const v = () => {
      ...
      const O = Math.floor(I / (1e3 * 60 * 60)), J = Math.floor(I % (1e3 * 60 * 60) / (1e3 * 60)), Y = Math.floor(I % (1e3 * 60) / 1e3);
      R({ hours: O, minutes: J, seconds: Y });
    };
    v();
  ...
  const V = async (v, C) => {
    try {
      await navigator.clipboard.writeText(v), C === "link" ? (P(true), setTimeout(() => P(false), 2e3)) : (E(true), setTimeout(() => E(false), 2e3)), U({ title: "Copied!", description: e.jsxs("div", { className: "flex items-center gap-2", children: [e.jsx(ee, { className: "w-4 h-4 text-primary" }), e.jsxs("span", { children: [C === "link" ? "Secure link" : "Access code", " copied to clipboard."] })] }) });
    } catch {
  ...
  return e.jsxs(X.div, { initial: { opacity: 0, scale: 0.95 }, animate: { opacity: 1, scale: 1 }, transition: { duration: 0.4, ease: "easeOut" }, className: `glass-card overflow-hidden ring-1 ring-white/10 ${D}`, children: [e.jsx("div", { className: "relative h-1 w-full bg-zinc-900 pointer-events-none overflow-hidden", children: e.jsx("div", { className: `absolute inset-0 bg-gradient-to-r from-transparent ${z ? "via-rose-500" : "via-primary"} to-transparent w-1/2 animate-shimmer opacity-70` }) }), e.jsxs("div", { className: "p-5 md:p-8", children: [!$ && e.jsxs("div", { className: "flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8 md:mb-10", children: [e.jsxs("div", { className: "flex items-center gap-4", children: [e.jsxs("div", { className: "relative shrink-0", children: [e.jsx("div", { className: "w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-2xl flex items-center justify-center border border-zinc-700 shadow-inner", children: e.jsx(Ve, { className: `w-7 h-7 md:w-8 md:h-8 ${z ? "text-rose-500" : "text-primary"}` }) }), e.jsx("div", { className: "absolute -bottom-1 -right-1 bg-zinc-900 rounded-full p-1 border border-zinc-800", children: z ? e.jsx(W, { className: "w-3 h-3 md:w-4 md:h-4 text-rose-500" }) : e.jsx(fe, { className: "w-3 h-3 md:w-4 md:h-4 text-primary" }) })] }), e.jsxs("div", { children: [e.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [e.jsx("h2", { className: "text-xl md:text-2xl font-bold font-mono tracking-tight text-foreground", children: "SECURE VAULT" }), e.jsx("span", { className: `px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-wider border ${z ? "bg-rose-500/10 border-rose-500/20 text-rose-500" : "bg-primary/10 border-primary/20 text-primary"}`, children: z ? "Archived" : "Active" })] }), e.jsxs("p", { className: "text-xs md:text-sm text-muted-foreground flex items-center gap-2", children: [e.jsx("span", { className: "font-medium text-foreground", children: p }), " ", p === 1 ? "file" : "files", e.jsx("span", { className: "w-1 h-1 rounded-full bg-zinc-700" }), e.jsx("span", { className: "font-medium text-foreground", children: (l / (1024 * 1024)).toFixed(2) }), " MB"] })] })] }), e.jsxs("div", { className: "flex flex-col items-end w-full md:w-auto mt-2 md:mt-0", children: [e.jsxs("div", { className: `flex items-center gap-2 mb-2 text-xs uppercase font-bold tracking-widest ${S || z ? "text-rose-500" : "text-primary"}`, children: [e.jsx(Ce, { className: "w-3.5 h-3.5" }), z ? "Vault Expired" : "Auto-Purge In"] }), z ? e.jsx("div", { className: "h-12 md:h-14 flex items-center px-4 bg-rose-500/10 border border-rose-500/20 rounded-lg w-full md:w-auto justify-center", children: e.jsx("span", { className: "font-mono text-lg md:text-xl font-bold text-rose-500 tracking-widest", children: "DELETED" }) }) : e.jsxs("div", { className: "flex items-center justify-center gap-1.5 md:gap-2 bg-zinc-900/50 p-2 rounded-xl border border-zinc-800/50 backdrop-blur-sm w-full md:w-auto", children: [e.jsx(se, { value: (N == null ? void 0 : N.hours) || 0, label: "HRS" }), e.jsx(pe, {}), e.jsx(se, { value: (N == null ? void 0 : N.minutes) || 0, label: "MIN" }), e.jsx(pe, {}), e.jsx(se, { value: (N == null ? void 0 : N.seconds) || 0, label: "SEC" })] })] })] }), e.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8", children: [e.jsxs("div", { className: "flex flex-col items-center order-1 lg:order-none", children: [e.jsxs("div", { className: "relative group w-full max-w-[240px] lg:max-w-none", children: [e.jsx("div", { className: "absolute -inset-0.5 bg-gradient-to-tr from-primary/50 to-emerald-600/50 rounded-2xl blur opacity-75 group-hover:opacity-100 transition duration-500" }), e.jsxs("div", { className: "relative bg-zinc-950 p-4 md:p-6 rounded-xl border border-primary/20 shadow-2xl overflow-hidden aspect-square flex items-center justify-center", children: [e.jsx(X.div, { className: "absolute inset-0 bg-gradient-to-b from-transparent via-primary/10 to-transparent z-10", animate: { top: ["-100%", "100%"] }, transition: { duration: 3, repeat: 1 / 0, ease: "linear" } }), e.jsx("div", { className: "bg-white p-2 rounded-lg relative z-0 w-full h-full flex items-center justify-center", children: e.jsx(Ie, { value: u, size: 200, className: "w-full h-full", level: "H", includeMargin: true, bgColor: "#FFFFFF", fgColor: "#16a34a", imageSettings: { src: "/vault-qr-icon.png", height: 48, width: 48, excavate: true } }) })] })] }), e.jsxs("p", { className: "mt-4 text-[10px] md:text-xs font-mono text-zinc-500 uppercase tracking-[0.2em] flex items-center gap-2", children: [e.jsx("span", { className: "w-2 h-2 rounded-full bg-primary animate-pulse" }), "Scan to Access"] })] }), e.jsxs("div", { className: "lg:col-span-2 space-y-4 md:space-y-5 order-2 lg:order-none", children: [e.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [e.jsxs("div", { className: "p-4 bg-zinc-900 border border-zinc-800 rounded-xl relative group overflow-hidden flex flex-col justify-between min-h-[110px]", children: [e.jsx("div", { className: "absolute top-0 right-0 p-2 opacity-50 group-hover:opacity-100 transition-opacity z-10", children: e.jsx(F, { variant: "ghost", size: "icon", onClick: () => V(a, "code"), className: "h-8 w-8 hover:bg-zinc-800 text-zinc-400 hover:text-white", children: j ? e.jsx(ee, { className: "w-4 h-4 text-primary" }) : e.jsx(ce, { className: "w-4 h-4" }) }) }), e.jsx("div", { className: "text-[10px] uppercase font-bold text-zinc-500 tracking-wider mb-1", children: "Access PIN" }), e.jsx("div", { className: "flex-1 flex items-center justify-center w-full", children: e.jsx("div", { className: "font-mono text-xl sm:text-2xl md:text-3xl font-bold text-primary tracking-widest drop-shadow-lg whitespace-nowrap", children: a }) })] }), e.jsxs("div", { className: "p-4 bg-zinc-900 border border-zinc-800 rounded-xl relative flex flex-col justify-between min-h-[110px]", children: [e.jsxs("div", { className: "flex items-center justify-between mb-3", children: [e.jsxs("div", { className: "text-[10px] uppercase font-bold text-zinc-500 tracking-wider flex items-center gap-1.5", children: [e.jsx(ae, { className: "w-3 h-3" }), "Downloads"] }), e.jsxs("span", { className: `font-mono text-[10px] font-bold px-1.5 py-0.5 rounded border ${h >= d ? "bg-rose-500/10 border-rose-500/20 text-rose-500" : "bg-zinc-800 border-zinc-700 text-zinc-300"}`, children: [d - h, " LEFT"] })] }), e.jsxs("div", { className: "space-y-2", children: [e.jsx("div", { className: "flex gap-1 h-3 w-full", children: Array.from({ length: Math.min(d, 20) }).map((v, C) => {
    const L = C < h;
  ...
  }) }), e.jsxs("div", { className: "flex justify-between items-center text-[10px] font-mono text-zinc-500", children: [e.jsx("span", { children: "0" }), e.jsxs("span", { children: [h, " / ", d, " used"] }), e.jsx("span", { children: d })] })] })] })] }), e.jsx("div", { children: e.jsxs("div", { className: "relative group", children: [e.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-primary/20 to-transparent rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-500" }), e.jsxs("div", { className: "relative flex items-center bg-zinc-900/80 border border-zinc-700 hover:border-primary/50 rounded-xl p-1 pr-2 transition-colors", children: [e.jsx("div", { className: "h-10 w-10 flex items-center justify-center text-zinc-500 shrink-0", children: e.jsx(_e, { className: "w-4 h-4" }) }), e.jsxs("div", { className: "flex-1 min-w-0 px-2 overflow-hidden", children: [e.jsx("div", { className: "text-[10px] text-zinc-500 font-semibold uppercase tracking-wider mb-0.5", children: "Secure Link" }), e.jsx("div", { className: "text-sm font-mono text-zinc-300 truncate selection:bg-primary/30", children: u })] }), e.jsxs(F, { variant: "secondary", size: "sm", onClick: () => V(u, "link"), className: "h-9 gap-2 shadow-sm font-medium shrink-0", children: [k ? e.jsx(ee, { className: "w-3.5 h-3.5" }) : e.jsx(ce, { className: "w-3.5 h-3.5" }), e.jsx("span", { className: "hidden md:inline", children: k ? "Copied" : "Copy" })] })] })] }) }), x && !z && e.jsxs("div", { className: "pt-4 mt-2", children: [e.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [e.jsx("div", { className: "p-1.5 bg-zinc-800 rounded-md", children: e.jsx(Be, { className: "w-4 h-4 text-zinc-400" }) }), e.jsx("span", { className: "text-sm font-medium text-foreground", children: "Secure Send" })] }), e.jsxs("div", { className: "flex flex-col md:flex-row gap-2", children: [e.jsx(Te, { type: "email", placeholder: "Enter recipient email...", value: M, onChange: (v) => B(v.target.value), className: "bg-zinc-900/50 border-zinc-800 hover:border-zinc-700 focus:border-primary/50 transition-colors" }), e.jsx(F, { onClick: _, disabled: !M || T, className: "w-full md:w-auto min-w-[100px] cyber-btn", children: T ? e.jsx(re, { className: "w-4 h-4 animate-spin" }) : "Send" })] }), e.jsx("p", { className: "text-[11px] text-zinc-500 mt-2 pl-1", children: "* Encrypted link sent only. No files attached." })] })] })] }), e.jsxs("div", { className: "mt-8 pt-6 border-t border-white/5 flex flex-col md:flex-row items-start gap-4", children: [e.jsx("div", { className: "hidden md:block p-2 bg-rose-500/10 rounded-lg shrink-0", children: e.jsx(W, { className: "w-5 h-5 text-rose-500" }) }), e.jsxs("div", { children: [e.jsxs("div", { className: "flex items-center gap-2 md:hidden mb-2 text-rose-500 font-bold text-sm", children: [e.jsx(W, { className: "w-4 h-4" }), e.jsx("span", { children: "Self-Destruction Protocol" })] }), e.jsx("h4", { className: "hidden md:block text-sm font-bold text-rose-500 mb-1", children: "Self-Destruction Protocol Active" }), e.jsxs("p", { className: "text-xs text-zinc-400 leading-relaxed max-w-2xl", children: ["This vault is encrypted with a unique key. Once the limit is reached or timer expires, data is permanently purged.", e.jsx("span", { className: "text-zinc-300 font-medium", children: " No recovery option." })] })] })] })] })] });
}
function ut() {
  const [, s] = Ae("/v/:id"), a = s == null ? void 0 : s.id, [u, p] = o.useState(null), [l, b] = o.useState([]), [h, d] = o.useState(true), [x, D] = o.useState(null), [$, k] = o.useState(null), [P, j] = o.useState(0), [E, N] = o.useState(null), [R, M] = o.useState(false), [B, T] = o.useState(false), { data: y, isLoading: U, error: V } = Pe(a || ""), _ = Le(), z = Fe(), { toast: S } = he(), [v, C] = o.useState(/* @__PURE__ */ new Map()), [L, Q] = o.useState(false), I = o.useRef(null);
  o.useEffect(() => (I.current = new Worker(new URL("/assets/encryption.worker-UhEl2skF.js", import.meta.url), { type: "module" }), () => {
    var _a;
    return (_a = I.current) == null ? void 0 : _a.terminate();
  }), []), o.useEffect(() => {
    ...
    y && (async () => {
      if (y) try {
        ...
        const c = (await Ue(y.encryptedMetadata, n)).map((g) => {
          ...
          return { ...g, chunks: (w == null ? void 0 : w.chunkCount) || 0, isCompressed: (w == null ? void 0 : w.isCompressed) || false };
        });
        b(c);
  ...
  const O = async (t) => {
    ...
    try {
      if (m) {
        ...
        const r = await O(t), n = await me(t.fileId, u, r, { name: t.name, size: t.size, type: t.type, fileId: t.fileId, isCompressed: t.isCompressed }, (i) => {
          j(10 + i.progress * 0.9);
        });
    ...
    const t = l.filter((m) => {
      var _a;
      return !((_a = v.get(m.fileId)) == null ? void 0 : _a.isExhausted);
    });
    if (t.length === 0) {
    ...
    try {
      for (let m = 0; m < t.length; m++) {
        ...
        try {
          if (n) {
            const i = await O(r), c = await me(r.fileId, u, i, { name: r.name, size: r.size, type: r.type, fileId: r.fileId, isCompressed: r.isCompressed }, (f) => {
              j(10 + f.progress * 0.9);
            });
      ...
      k(null), j(0), N(null), Q(false);
    }
  }, oe = (t, m, r, n) => new Promise((i, c) => {
    if (!I.current) return c("Worker not ready");
    const f = Math.random(), g = (w) => {
      var _a;
      w.data.id === f && ((_a = I.current) == null ? void 0 : _a.removeEventListener("message", g), w.data.type === "error" ? c(w.data.error) : i(w.data.decryptedData));
    };
    I.current.addEventListener("message", g), I.current.postMessage({ type: "decrypt", data: t, iv: m, key: r, id: f, isCompressed: n }, [t]);
  });
  return B ? e.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background p-4 animate-in fade-in duration-1000", children: e.jsxs("div", { className: "max-w-md w-full text-center space-y-6", children: [e.jsxs("div", { className: "w-20 h-20 bg-zinc-900 border-2 border-zinc-800 rounded-full flex items-center justify-center mx-auto relative overflow-hidden group", children: [e.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-destructive/20 to-transparent" }), e.jsx(fe, { className: "w-10 h-10 text-muted-foreground/50" })] }), e.jsxs("div", { className: "space-y-2", children: [e.jsx("h1", { className: "text-3xl font-bold font-mono text-muted-foreground uppercase tracking-widest", children: "Link Terminated" }), e.jsx("p", { className: "text-zinc-500", children: "This vault has self-destructed. No data remains." })] }), e.jsx(F, { onClick: () => window.location.href = "/", variant: "outline", className: "border-zinc-800 hover:bg-zinc-900 hover:text-white", children: "Return to Safety" })] }) }) : U ? e.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background", children: e.jsx(re, { className: "w-10 h-10 text-primary animate-spin" }) }) : V || x ? e.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background p-4", children: e.jsxs("div", { className: "max-w-md w-full bg-card border border-destructive/30 rounded-xl p-8 text-center", children: [e.jsx("div", { className: "w-16 h-16 bg-destructive/10 rounded-full flex items-center justify-center mx-auto mb-4 text-destructive", children: e.jsx(W, { className: "w-8 h-8" }) }), e.jsx("h2", { className: "text-xl font-bold mb-2", children: "Access Denied" }), e.jsx("p", { className: "text-muted-foreground mb-6", children: x || (V == null ? void 0 : V.message) || "Vault not found" }), e.jsx(F, { onClick: () => window.location.href = "/", variant: "outline", children: "Go Home" })] }) }) : e.jsx("div", { className: `min-h-screen bg-background p-4 md:p-8 flex flex-col ${R ? "burn-container" : ""}`, children: e.jsxs("div", { className: "max-w-4xl mx-auto space-y-6 md:space-y-8 w-full flex-1", children: [e.jsxs("header", { className: "flex items-center justify-between mb-6 md:mb-8", children: [e.jsx(K, { href: "/", children: e.jsxs("div", { className: "flex items-center gap-3 cursor-pointer", children: [e.jsx("div", { className: "w-8 h-8 md:w-10 md:h-10 bg-primary/20 rounded-lg flex items-center justify-center border border-primary/50 overflow-hidden", children: e.jsx("img", { src: "/vault-logo.jpg", alt: "VaultBridge", className: "w-full h-full object-cover p-1" }) }), e.jsx("div", { children: e.jsxs("h1", { className: "text-lg md:text-xl font-bold font-mono tracking-tighter", children: ["VAULT", e.jsx("span", { className: "text-primary", children: "BRIDGE" })] }) })] }) }), e.jsx(K, { href: "/", children: e.jsxs(F, { variant: "ghost", size: "sm", className: "gap-2 text-muted-foreground hover:text-foreground hover:bg-secondary/50", children: [e.jsx($e, { className: "w-4 h-4" }), e.jsx("span", { className: "hidden sm:inline", children: "Return" })] }) })] }), y && e.jsx(tt, { vaultId: y.id, shortCode: y.shortCode, fullLink: window.location.href.split("#")[0], filesCount: l.length, totalSize: l.reduce((t, m) => t + m.size, 0), expiresAt: y.expiresAt, downloads: y.downloadCount, maxDownloads: y.maxDownloads }), e.jsxs("div", { className: "space-y-4", children: [e.jsx("h3", { className: "text-base md:text-lg font-bold font-mono uppercase tracking-wider text-muted-foreground mb-2 md:mb-4", children: "Encrypted Contents" }), h ? e.jsxs("div", { className: "p-6 md:p-8 text-center text-muted-foreground animate-pulse", children: [e.jsx(Ge, { className: "w-6 h-6 md:w-8 md:h-8 mx-auto mb-2 opacity-50" }), e.jsx("p", { className: "text-sm md:text-base", children: "Decrypting metadata..." })] }) : e.jsxs(e.Fragment, { children: [l.map((t) => {
    const m = v.get(t.fileId), r = (m == null ? void 0 : m.remainingDownloads) ?? 0, n = (m == null ? void 0 : m.maxDownloads) ?? 0, i = (m == null ? void 0 : m.isExhausted) ?? false;
    return e.jsxs(X.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, className: `bg-card border rounded-xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 group transition-colors ${i ? "border-destructive/30 opacity-60" : "border-border hover:border-primary/30"}`, children: [e.jsxs("div", { className: "flex items-center gap-3 md:gap-4 overflow-hidden", children: [e.jsx("div", { className: "p-2 md:p-3 bg-secondary rounded-lg flex-shrink-0", children: e.jsx(Oe, { className: `w-5 h-5 md:w-6 md:h-6 ${i ? "text-destructive" : "text-primary"}` }) }), e.jsxs("div", { className: "min-w-0 flex-1", children: [e.jsx("p", { className: "font-medium truncate text-sm md:text-base", children: t.name }), e.jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [e.jsxs("p", { className: "text-xs text-muted-foreground font-mono", children: [(t.size / (1024 * 1024)).toFixed(2), " MB \u2022 ", t.type || "Unknown"] }), e.jsx("span", { className: "w-1 h-1 rounded-full bg-muted-foreground/30" }), e.jsxs("span", { className: `text-[10px] font-bold uppercase ${i ? "text-destructive" : r <= 1 ? "text-amber-400" : "text-primary"}`, children: [r, "/", n, " DL"] })] })] })] }), e.jsx("div", { className: "flex items-center gap-4 w-full md:w-auto mt-2 md:mt-0", children: $ === t.fileId ? e.jsxs("div", { className: "w-full md:w-48 space-y-2", children: [e.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground", children: [e.jsxs("span", { children: [E === "stream" ? "Stream " : "", "Decrypting..."] }), e.jsxs("span", { children: [Math.round(P), "%"] })] }), e.jsx(Ne, { value: P, className: "h-1.5 md:h-2" })] }) : e.jsx(F, { onClick: () => J(t), disabled: i || L, className: `w-full md:w-auto font-mono text-sm md:text-base h-10 md:h-11 ${i ? "bg-muted text-muted-foreground cursor-not-allowed" : "bg-primary text-primary-foreground hover:bg-primary/90"}`, children: i ? "Limit Reached" : te(t.size) ? e.jsxs(e.Fragment, { children: [e.jsx(Me, { className: "w-4 h-4 mr-2 text-amber-500" }), "Download"] }) : e.jsxs(e.Fragment, { children: [e.jsx(ae, { className: "w-4 h-4 mr-2" }), "Download"] }) }) })] }, t.fileId);
  }), l.length > 1 && e.jsxs(e.Fragment, { children: [e.jsx(F, { onClick: Y, disabled: L || $ !== null || Array.from(v.values()).every((t) => t.isExhausted) && v.size > 0, className: `w-full h-12 mt-4 font-mono text-sm md:text-base uppercase tracking-wider ${Array.from(v.values()).every((t) => t.isExhausted) && v.size > 0 ? "bg-muted text-muted-foreground cursor-not-allowed" : L ? "bg-primary/70 text-primary-foreground cursor-wait" : "bg-primary text-primary-foreground hover:bg-primary/90"}`, children: L ? e.jsxs(e.Fragment, { children: [e.jsx(re, { className: "w-4 h-4 mr-2 animate-spin" }), "Downloading All..."] }) : Array.from(v.values()).every((t) => t.isExhausted) && v.size > 0 ? "All Limits Reached" : e.jsxs(e.Fragment, { children: [e.jsx(ae, { className: "w-4 h-4 mr-2" }), "Download All Files"] }) }), e.jsxs("p", { className: "text-[10px] md:text-xs text-center text-muted-foreground mt-4 opacity-70", children: ["By continuing, you agree to our ", e.jsx(K, { href: "/terms", className: "underline hover:text-primary transition-colors", children: "Terms of Service" }), " & ", e.jsx(K, { href: "/privacy", className: "underline hover:text-primary transition-colors", children: "Privacy Policy" }), "."] })] })] })] })] }) });
}
export {
  ut as default
};
