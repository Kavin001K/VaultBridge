...
async function A(e, t) {
  try {
    const { iv: n, data: r } = JSON.parse(e), a = c(n), y = c(r), i = await u(y, new Uint8Array(a), t), d = new TextDecoder();
    return JSON.parse(d.decode(i));
  } catch (n) {
...
async function m(e, t) {
  const n = await s(t), r = await window.crypto.subtle.wrapKey("raw", e, n, "AES-KW");
  return o(r);
}
async function B(e, t) {
  const n = await s(t), r = c(e);
