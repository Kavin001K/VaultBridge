import { r as l, j as e, d as c, S as x, B as u, k as y, m as i, L as g } from "./index-ByPnYQL4.js";
import { C as f } from "./chevron-up-C0ZX9uWa.js";
import { S as b } from "./shield-check-BSGM-k8u.js";
function j() {
  ...
  }, o = (t) => t.split(/(\*\*.*?\*\*)/g).map((s, r) => s.startsWith("**") && s.endsWith("**") ? e.jsx("strong", { className: "text-emerald-400 font-bold", children: s.slice(2, -2) }, r) : s), n = [{ id: "core-axiom", title: "1. The Core Axiom", content: `
