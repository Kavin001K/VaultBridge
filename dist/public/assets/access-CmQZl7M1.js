import { r as f, k as Q, u as X, j as e, L as P, B as z, b as R, _ as ee, __tla as __tla_0 } from "./index-YOfmkex7.js";
import { I as te } from "./input-CIv7KZUk.js";
import { c as se, d as ae, e as re } from "./use-vaults-C2paA_jW.js";
import { u as ne, d as ie, f as oe } from "./crypto-B7jyo7TG.js";
import { i as le } from "./downloadStream-B9ePKBR3.js";
import { m as c } from "./proxy-B4MdC-kl.js";
import { L as V } from "./lock-BzrikEyi.js";
import { A as ce } from "./arrow-left-j2_1CXen.js";
import { K as de } from "./key-round-CL022Zbj.js";
import { A as E } from "./index-2TAiR71A.js";
import { S as K } from "./shield-6khoS6J-.js";
import { C as me, H as xe } from "./hard-drive-BZvsWXu4.js";
import { D as S } from "./download-gW4CQ_I2.js";
import { F as pe } from "./file-text-CCKoIjFG.js";
import { T as O } from "./triangle-alert-Bx0eBFtd.js";
let Se;
let __tla = Promise.all([
  ...
  Se = function() {
    const [o, y] = f.useState(""), [l, x] = f.useState("input"), [N, p] = f.useState(""), [g, b] = f.useState([]), [i, k] = f.useState(null), [j, W] = f.useState(null), [D, F] = f.useState(false);
    Q();
    const { toast: u } = X(), q = se(), _ = ae(), L = re(), T = async () => {
      ...
      if (!(!i || !j)) try {
        ...
        for (let m = 0; m < s.chunkCount; m++) {
          ...
          const { downloadUrl: C } = await _.mutateAsync({
            vaultId: i.id,
            fileId: t.fileId,
            chunkIndex: m
          });
          ...
          for (let w = 0; w < 3; w++) try {
            ...
            w < 2 && await new Promise((A) => setTimeout(A, 500 * Math.pow(2, w)));
          }
          ...
          if (t.isCompressed) {
            ...
            await w.default;
            const B = new Uint8Array($), A = w.decompress(B);
            a.push(A.buffer);
          } else a.push($);
        }
      ...
      if (!(!i || !j)) try {
        if ("serviceWorker" in navigator && navigator.serviceWorker.controller && t.size > 10 * 1024 * 1024) {
          ...
          for (let r = 0; r < s.chunkCount; r++) {
            const { downloadUrl: n } = await _.mutateAsync({
              vaultId: i.id,
              fileId: t.fileId,
              chunkIndex: r
            });
