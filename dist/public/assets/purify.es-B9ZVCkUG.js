...
const { entries: _t, setPrototypeOf: ct, isFrozen: Yt, getPrototypeOf: Xt, getOwnPropertyDescriptor: jt } = Object;
let { freeze: S, seal: L, create: ve } = Object, { apply: ke, construct: Ue } = typeof Reflect < "u" && Reflect;
S || (S = function(o) {
  return o;
});
L || (L = function(o) {
...
ke || (ke = function(o, l) {
  for (var a = arguments.length, c = new Array(a > 2 ? a - 2 : 0), O = 2; O < a; O++) c[O - 2] = arguments[O];
  return o.apply(l, c);
});
Ue || (Ue = function(o) {
...
function Jt(s) {
  for (let o = 0; o < s.length; o++) y(s, o) || (s[o] = null);
  return s;
}
function I(s) {
  const o = ve(null);
  for (const [l, a] of _t(s)) y(s, l) && (Array.isArray(a) ? o[l] = Jt(a) : a && typeof a == "object" && a.constructor === Object ? o[l] = I(a) : o[l] = a);
  return o;
}
function J(s, o) {
  for (; s !== null; ) {
...
var dt = Object.freeze({ __proto__: null, ARIA_ATTR: rn, ATTR_WHITESPACE: ln, CUSTOM_ELEMENT: cn, DATA_ATTR: an, DOCTYPE_NAME: At, ERB_EXPR: nn, IS_ALLOWED_URI: gt, IS_SCRIPT_OR_DATA: sn, MUSTACHE_EXPR: tn, TMPLIT_EXPR: on });
const Q = { element: 1, text: 3, progressingInstruction: 7, comment: 8, document: 9 }, fn = function() {
  ...
  try {
    return o.createPolicy(O, { createHTML(v) {
      return v;
    }, createScriptURL(v) {
      return v;
    } });
...
function ht() {
  ...
  const o = (i) => ht(i);
  if (o.version = "3.3.1", o.removed = [], !s || !s.document || s.document.nodeType !== Q.document || !s.Element) return o.isSupported = false, o;
  let { document: l } = s;
  const a = l, c = a.currentScript, { DocumentFragment: O, HTMLTemplateElement: v, Node: me, Element: Fe, NodeFilter: B, NamedNodeMap: St = s.NamedNodeMap || s.MozNamedAttrMap, HTMLFormElement: Rt, DOMParser: Ot, trustedTypes: ee } = s, Y = Fe.prototype, Dt = J(Y, "cloneNode"), Lt = J(Y, "remove"), yt = J(Y, "nextSibling"), bt = J(Y, "childNodes"), te = J(Y, "parentNode");
  if (typeof v == "function") {
    const i = l.createElement("template");
    i.content && i.content.ownerDocument && (l = i.content.ownerDocument);
  }
  let g, X = "";
  const { implementation: pe, createNodeIterator: Nt, createDocumentFragment: It, getElementsByTagName: Ct } = l, { importNode: Mt } = a;
  let A = Et();
  o.isSupported = typeof _t == "function" && typeof te == "function" && pe && pe.createHTMLDocument !== void 0;
  const { MUSTACHE_EXPR: Te, ERB_EXPR: de, TMPLIT_EXPR: Ee, DATA_ATTR: wt, ARIA_ATTR: xt, IS_SCRIPT_OR_DATA: Pt, ATTR_WHITESPACE: He, CUSTOM_ELEMENT: vt } = dt;
  let { IS_ALLOWED_URI: ze } = dt, T = null;
  const Ge = r({}, [...ut, ...Me, ...we, ...xe, ...mt]);
  let d = null;
  const We = r({}, [...pt, ...Pe, ...Tt, ...fe]);
  let u = Object.seal(ve(null, { tagNameCheck: { writable: true, configurable: false, enumerable: true, value: null }, attributeNameCheck: { writable: true, configurable: false, enumerable: true, value: null }, allowCustomizedBuiltInElements: { writable: true, configurable: false, enumerable: true, value: false } })), j = null, _e = null;
  const k = Object.seal(ve(null, { tagCheck: { writable: true, configurable: false, enumerable: true, value: null }, attributeCheck: { writable: true, configurable: false, enumerable: true, value: null } }));
  let Be = true, ge = true, Ye = false, Xe = true, U = false, ne = true, x = false, Ae = false, he = false, F = false, oe = false, ie = false, je = true, Ve = false;
  const kt = "user-content-";
  let Se = true, V = false, H = {}, b = null;
  ...
  const Gt = l.createElement("form"), Ze = function(e) {
    ...
    if (!(G && G === e)) {
      if ((!e || typeof e != "object") && (e = {}), e = I(e), $ = Ht.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? zt : e.PARSER_MEDIA_TYPE, p = $ === "application/xhtml+xml" ? Ie : ue, T = y(e, "ALLOWED_TAGS") ? r({}, e.ALLOWED_TAGS, p) : Ge, d = y(e, "ALLOWED_ATTR") ? r({}, e.ALLOWED_ATTR, p) : We, Le = y(e, "ALLOWED_NAMESPACES") ? r({}, e.ALLOWED_NAMESPACES, Ie) : Ut, Oe = y(e, "ADD_URI_SAFE_ATTR") ? r(I(Ke), e.ADD_URI_SAFE_ATTR, p) : Ke, $e = y(e, "ADD_DATA_URI_TAGS") ? r(I(qe), e.ADD_DATA_URI_TAGS, p) : qe, b = y(e, "FORBID_CONTENTS") ? r({}, e.FORBID_CONTENTS, p) : Re, j = y(e, "FORBID_TAGS") ? r({}, e.FORBID_TAGS, p) : I({}), _e = y(e, "FORBID_ATTR") ? r({}, e.FORBID_ATTR, p) : I({}), H = y(e, "USE_PROFILES") ? e.USE_PROFILES : false, Be = e.ALLOW_ARIA_ATTR !== false, ge = e.ALLOW_DATA_ATTR !== false, Ye = e.ALLOW_UNKNOWN_PROTOCOLS || false, Xe = e.ALLOW_SELF_CLOSE_IN_ATTR !== false, U = e.SAFE_FOR_TEMPLATES || false, ne = e.SAFE_FOR_XML !== false, x = e.WHOLE_DOCUMENT || false, F = e.RETURN_DOM || false, oe = e.RETURN_DOM_FRAGMENT || false, ie = e.RETURN_TRUSTED_TYPE || false, he = e.FORCE_BODY || false, je = e.SANITIZE_DOM !== false, Ve = e.SANITIZE_NAMED_PROPS || false, Se = e.KEEP_CONTENT !== false, V = e.IN_PLACE || false, ze = e.ALLOWED_URI_REGEXP || gt, z = e.NAMESPACE || C, se = e.MATHML_TEXT_INTEGRATION_POINTS || se, le = e.HTML_INTEGRATION_POINTS || le, u = e.CUSTOM_ELEMENT_HANDLING || {}, e.CUSTOM_ELEMENT_HANDLING && Ze(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (u.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck), e.CUSTOM_ELEMENT_HANDLING && Ze(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (u.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), e.CUSTOM_ELEMENT_HANDLING && typeof e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (u.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), U && (ge = false), oe && (F = true), H && (T = r({}, mt), d = [], H.html === true && (r(T, ut), r(d, pt)), H.svg === true && (r(T, Me), r(d, Pe), r(d, fe)), H.svgFilters === true && (r(T, we), r(d, Pe), r(d, fe)), H.mathMl === true && (r(T, xe), r(d, Tt), r(d, fe))), e.ADD_TAGS && (typeof e.ADD_TAGS == "function" ? k.tagCheck = e.ADD_TAGS : (T === Ge && (T = I(T)), r(T, e.ADD_TAGS, p))), e.ADD_ATTR && (typeof e.ADD_ATTR == "function" ? k.attributeCheck = e.ADD_ATTR : (d === We && (d = I(d)), r(d, e.ADD_ATTR, p))), e.ADD_URI_SAFE_ATTR && r(Oe, e.ADD_URI_SAFE_ATTR, p), e.FORBID_CONTENTS && (b === Re && (b = I(b)), r(b, e.FORBID_CONTENTS, p)), e.ADD_FORBID_CONTENTS && (b === Re && (b = I(b)), r(b, e.ADD_FORBID_CONTENTS, p)), Se && (T["#text"] = true), x && r(T, ["html", "head", "body"]), T.table && (r(T, ["tbody"]), delete j.tbody), e.TRUSTED_TYPES_POLICY) {
      ...
      } else g === void 0 && (g = un(ee, c)), g !== null && typeof X == "string" && (X = g.createHTML(""));
      S && S(e), G = e;
    }
    ...
    if (t.removeAttribute(e), e === "is") if (F || oe) try {
      N(t);
    } catch {
    }
    else try {
    ...
    return Nt.call(e.ownerDocument || e, e, B.SHOW_ELEMENT | B.SHOW_COMMENT | B.SHOW_TEXT | B.SHOW_PROCESSING_INSTRUCTION | B.SHOW_CDATA_SECTION, null);
  }, be = function(e) {
  ...
  const ot = function(e) {
    let t = null;
    if (M(A.beforeSanitizeElements, e, null), be(e)) return N(e), true;
    const n = p(e.nodeName);
    if (M(A.uponSanitizeElement, e, { tagName: n, allowedTags: T }), ne && e.hasChildNodes() && !nt(e.firstElementChild) && h(/<[/\w!]/g, e.innerHTML) && h(/<[/\w!]/g, e.textContent) || e.nodeType === Q.progressingInstruction || ne && e.nodeType === Q.comment && h(/<[/\w]/g, e.data)) return N(e), true;
    if (!(k.tagCheck instanceof Function && k.tagCheck(n)) && (!T[n] || j[n])) {
      if (!j[n] && at(n) && (u.tagNameCheck instanceof RegExp && h(u.tagNameCheck, n) || u.tagNameCheck instanceof Function && u.tagNameCheck(n))) return false;
      if (Se && !b[n]) {
    ...
    return e instanceof Fe && !Wt(e) || (n === "noscript" || n === "noembed" || n === "noframes") && h(/<\/no(script|embed|frames)/i, e.innerHTML) ? (N(e), true) : (U && e.nodeType === Q.text && (t = e.textContent, ce([Te, de, Ee], (f) => {
      t = K(t, f, " ");
    }), e.textContent !== t && (q(o.removed, { element: e.cloneNode() }), e.textContent = t)), M(A.afterSanitizeElements, e, null), false);
  }, it = function(e, t, n) {
    if (je && (t === "id" || t === "name") && (n in l || n in Gt)) return false;
    if (!(ge && !_e[t] && h(wt, t))) {
      if (!(Be && h(xt, t))) {
    ...
    if (!t || be(e)) return;
    const n = { attrName: "", attrValue: "", keepAttr: true, allowedAttributes: d, forceKeepAttr: void 0 };
    let f = t.length;
    for (; f--; ) {
      const _ = t[f], { name: m, namespaceURI: D, value: w } = _, W = p(m), Ne = w;
      let E = m === "value" ? Ne : Kt(Ne);
      if (n.attrName = W, n.attrValue = E, n.keepAttr = true, n.forceKeepAttr = void 0, M(A.uponSanitizeAttribute, e, n), E = n.attrValue, Ve && (W === "id" || W === "name") && (P(m, e), E = kt + E), ne && h(/((--!?|])>)|<\/(style|title|textarea)/i, E)) {
        P(m, e);
        continue;
      }
      ...
      if (g && typeof ee == "object" && typeof ee.getAttributeType == "function" && !D) switch (ee.getAttributeType(st, W)) {
        case "TrustedHTML": {
          E = g.createHTML(E);
          break;
        }
    ...
    let t = null;
    const n = tt(e);
    for (M(A.beforeSanitizeShadowDOM, e, null); t = n.nextNode(); ) M(A.uponSanitizeShadowNode, t, null), ot(t), rt(t), t.content instanceof O && i(t.content);
  ...
  return o.sanitize = function(i) {
    ...
    if (De = !i, De && (i = "<!-->"), typeof i != "string" && !nt(i)) if (typeof i.toString == "function") {
    ...
    if (Ae || ye(e), o.removed = [], typeof i == "string" && (V = false), V) {
      if (i.nodeName) {
        const w = p(i.nodeName);
        if (!T[w] || j[w]) throw Z("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (i instanceof me) t = et("<!---->"), n = t.ownerDocument.importNode(i, true), n.nodeType === Q.element && n.nodeName === "BODY" || n.nodeName === "HTML" ? t = n : t.appendChild(n);
    else {
      if (!F && !U && !x && i.indexOf("<") === -1) return g && ie ? g.createHTML(i) : i;
      if (t = et(i), !t) return F ? null : ie ? X : "";
    }
    t && he && N(t.firstChild);
    const m = tt(V ? i : t);
    for (; f = m.nextNode(); ) ot(f), rt(f), f.content instanceof O && Bt(f.content);
    if (V) return i;
    if (F) {
      if (oe) for (_ = It.call(t.ownerDocument); t.firstChild; ) _.appendChild(t.firstChild);
      else _ = t;
      return (d.shadowroot || d.shadowrootmode) && (_ = Mt.call(a, _, true)), _;
    }
