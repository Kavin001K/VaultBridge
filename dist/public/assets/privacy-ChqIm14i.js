import { r as l, j as e, b as c, S as x, B as u, q as y, m as s, L as g } from "./index-BkiWEDQ0.js";
import { C as f } from "./chevron-up-8acPcrPR.js";
import { S as b } from "./shield-check-B2kuQ4ql.js";
function j() {
...
`).map((r, i) => {
  ...
  }) })] }, t.id)) })] }), e.jsx(s.button, { initial: { opacity: 0 }, animate: { opacity: d ? 1 : 0 }, onClick: h, className: "fixed bottom-8 right-8 p-3 bg-emerald-600 text-white rounded-full shadow-lg hover:bg-emerald-500 transition-colors z-50", children: e.jsx(f, { className: "w-5 h-5" }) })] }), e.jsx("footer", { className: "border-t border-white/5 py-12 mt-24 bg-zinc-950", children: e.jsxs("div", { className: "container px-4 text-center max-w-4xl mx-auto", children: [e.jsx(b, { className: "w-12 h-12 text-zinc-800 mx-auto mb-6" }), e.jsx("p", { className: "text-zinc-500 text-sm", children: "Last Updated: 2026 \u2022 VaultBridge Security Team" }), e.jsx("p", { className: "text-zinc-700 text-[10px] font-mono mt-2", children: "v1.3.0" })] }) })] });
}
export {
  j as default
};
