import { c as he, r as n, j as e, f as fe, P as te, a as ge, u as re, B as P, d as ae, l as ve } from "./index-BpGdq6cX.js";
import { A as be, f as we, d as je, e as ye } from "./use-vaults-CXcaDl-K.js";
import { j as Ne, f as ke } from "./crypto-DfIFm6ch.js";
import { Q as ze, E as Se } from "./index-CA7YEgmS.js";
import { C as Z, I as Ce } from "./input-BBnUsH8U.js";
import { m as _ } from "./proxy-D0nqRSzh.js";
import { H as De } from "./hard-drive-XNuwHd5K.js";
import { T as V } from "./triangle-alert-BcLzU2C0.js";
import { S as ne } from "./shield-check-BXL-eXVE.js";
import { C as Ie, a as G } from "./clock-BpwMaOFh.js";
import { D as ie } from "./download-Bv-5vb7D.js";
import { M as Ee } from "./mail-CW0eSsCi.js";
import { s as J, i as Pe } from "./downloadStream-BshqhEZj.js";
import { F as Le } from "./file-qpZt66M1.js";
import { Z as Ae } from "./zap-BdzjHAbs.js";
/**
...
function H({ value: t, label: r }) {
  return e.jsxs("div", { className: "flex flex-col items-center gap-1", children: [e.jsxs("div", { className: "relative group", children: [e.jsx("div", { className: "absolute -inset-0.5 bg-primary/20 rounded-lg blur opacity-50 group-hover:opacity-100 transition duration-500" }), e.jsxs("div", { className: "relative w-12 h-14 bg-zinc-900 border border-zinc-700 rounded-lg flex items-center justify-center overflow-hidden", children: [e.jsx(be, { mode: "popLayout", children: e.jsx(_.span, { initial: { y: 20, opacity: 0 }, animate: { y: 0, opacity: 1 }, exit: { y: -20, opacity: 0 }, transition: { type: "spring", stiffness: 300, damping: 30 }, className: "font-mono text-2xl font-bold text-primary", children: t.toString().padStart(2, "0") }, t) }), e.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-transparent via-primary/5 to-transparent opacity-20 pointer-events-none" })] })] }), e.jsx("span", { className: "text-[10px] uppercase font-bold text-zinc-600 tracking-wider font-mono", children: r })] });
}
function se() {
...
function Oe({ vaultId: t, shortCode: r, fullLink: p, filesCount: m, totalSize: i, expiresAt: z, downloads: y, maxDownloads: o, onSendEmail: x, className: S, minimal: B = false }) {
  ...
  }) }), e.jsxs("div", { className: "flex justify-between items-center text-[10px] font-mono text-zinc-500", children: [e.jsx("span", { children: "0" }), e.jsxs("span", { children: [y, " / ", o, " used"] }), e.jsx("span", { children: o })] })] })] })] }), e.jsx("div", { children: e.jsxs("div", { className: "relative group", children: [e.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-primary/20 to-transparent rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-500" }), e.jsxs("div", { className: "relative flex items-center bg-zinc-900/80 border border-zinc-700 hover:border-primary/50 rounded-xl p-1 pr-2 transition-colors", children: [e.jsx("div", { className: "h-10 w-10 flex items-center justify-center text-zinc-500 shrink-0", children: e.jsx(Se, { className: "w-4 h-4" }) }), e.jsxs("div", { className: "flex-1 min-w-0 px-2 overflow-hidden", children: [e.jsx("div", { className: "text-[10px] text-zinc-500 font-semibold uppercase tracking-wider mb-0.5", children: "Secure Link" }), e.jsx("div", { className: "text-sm font-mono text-zinc-300 truncate selection:bg-primary/30", children: p })] }), e.jsxs(P, { variant: "secondary", size: "sm", onClick: () => M(p, "link"), className: "h-9 gap-2 shadow-sm font-medium shrink-0", children: [L ? e.jsx(G, { className: "w-3.5 h-3.5" }) : e.jsx(Z, { className: "w-3.5 h-3.5" }), e.jsx("span", { className: "hidden md:inline", children: L ? "Copied" : "Copy" })] })] })] }) }), x && !f && e.jsxs("div", { className: "pt-4 mt-2", children: [e.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [e.jsx("div", { className: "p-1.5 bg-zinc-800 rounded-md", children: e.jsx(Ee, { className: "w-4 h-4 text-zinc-400" }) }), e.jsx("span", { className: "text-sm font-medium text-foreground", children: "Secure Send" })] }), e.jsxs("div", { className: "flex flex-col md:flex-row gap-2", children: [e.jsx(Ce, { type: "email", placeholder: "Enter recipient email...", value: C, onChange: (c) => U(c.target.value), className: "bg-zinc-900/50 border-zinc-800 hover:border-zinc-700 focus:border-primary/50 transition-colors" }), e.jsx(P, { onClick: $, disabled: !C || F, className: "w-full md:w-auto min-w-[100px] cyber-btn", children: F ? e.jsx(ae, { className: "w-4 h-4 animate-spin" }) : "Send" })] }), e.jsx("p", { className: "text-[11px] text-zinc-500 mt-2 pl-1", children: "* Encrypted link sent only. No files attached." })] })] })] }), e.jsxs("div", { className: "mt-8 pt-6 border-t border-white/5 flex flex-col md:flex-row items-start gap-4", children: [e.jsx("div", { className: "hidden md:block p-2 bg-rose-500/10 rounded-lg shrink-0", children: e.jsx(V, { className: "w-5 h-5 text-rose-500" }) }), e.jsxs("div", { children: [e.jsxs("div", { className: "flex items-center gap-2 md:hidden mb-2 text-rose-500 font-bold text-sm", children: [e.jsx(V, { className: "w-4 h-4" }), e.jsx("span", { children: "Self-Destruction Protocol" })] }), e.jsx("h4", { className: "hidden md:block text-sm font-bold text-rose-500 mb-1", children: "Self-Destruction Protocol Active" }), e.jsxs("p", { className: "text-xs text-zinc-400 leading-relaxed max-w-2xl", children: ["This vault is encrypted with a unique key. Once the limit is reached or timer expires, data is permanently purged.", e.jsx("span", { className: "text-zinc-300 font-medium", children: " No recovery option." })] })] })] })] })] });
}
function ns() {
  const [, t] = ve("/v/:id"), r = t == null ? void 0 : t.id, [p, m] = n.useState(null), [i, z] = n.useState([]), [y, o] = n.useState(true), [x, S] = n.useState(null), [B, L] = n.useState(null), [A, k] = n.useState(0), [T, b] = n.useState(null), [R, C] = n.useState(false), [U, F] = n.useState(false), { data: l, isLoading: D, error: M } = we(r || ""), $ = je(), f = ye(), { toast: I } = re(), c = n.useRef(null);
  n.useEffect(() => (c.current = new Worker(new URL("/assets/encryption.worker-UhEl2skF.js", import.meta.url), { type: "module" }), () => {
    ...
    l && (async () => {
      if (l) try {
        const a = await Ne(u);
        m(a);
        const j = (await ke(l.encryptedMetadata, a)).map((d) => {
  ...
  const w = async (s) => {
    ...
    try {
      if (u) {
        ...
        const h = await w(s), a = await Pe(s.fileId, p, h, { name: s.name, size: s.size, type: s.type, fileId: s.fileId, isCompressed: s.isCompressed }, (g) => {
          k(10 + g.progress * 0.9);
        });
