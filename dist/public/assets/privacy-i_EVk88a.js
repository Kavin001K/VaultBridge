import { r as l, j as e, L as c, d as x, B as u, k as y, m as s, b as g } from "./index-MFV0z_X9.js";
import { C as f } from "./chevron-up-zpuNuGnK.js";
import { S as b } from "./shield-check-DwABVzrz.js";
function j() {
  ...
  }, o = (t) => t.split(/(\*\*.*?\*\*)/g).map((i, r) => i.startsWith("**") && i.endsWith("**") ? e.jsx("strong", { className: "text-emerald-400 font-bold", children: i.slice(2, -2) }, r) : i), n = [{ id: "core-axiom", title: "1. The Core Axiom", content: `
...
`).map((i, r) => {
    const a = i.trim();
    return a.startsWith("###") ? e.jsx("h3", { className: "text-xl font-bold text-white mt-6 mb-3", children: o(a.replace("###", "").trim()) }, r) : a.startsWith("* ") ? e.jsx("li", { className: "ml-4 list-disc pl-1", children: o(a.replace("* ", "").trim()) }, r) : a.match(/^\d+\./) ? e.jsx("li", { className: "ml-4 list-decimal pl-1", children: o(a.replace(/^\d+\./, "").trim()) }, r) : a === "" ? e.jsx("br", {}, r) : a.startsWith("*") && a.endsWith("*") && a.length > 2 ? e.jsx("p", { className: "text-emerald-400/80 italic text-center mt-8 text-lg font-mono border-t border-emerald-500/20 pt-8", children: a.slice(1, -1) }, r) : e.jsx("p", { children: o(i) }, r);
